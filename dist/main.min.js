(function() {
    ...
    class GPActivation_ extends EventTarget {
        ...
        setActivationKey(a) {
            return GPActivation_.ACTIVATION_KEY_PATTERN.test(a) ? (this.s.activationKey = a,
            !0) : !1
        }
        ...
        constructor(a, b) {
            ...
            document.addEventListener("_auth_id", async({detail: {authId: c, authTypeId: d, isAuthorized: e}})=>{
                function g(p) {
                    ...
                    window[r.name].toggleSettingsVisibility = this.toggleSettingsVisibility(r),
                    r.initialized = !0),
                    r.locked = !1) : r.locked = !0);
                    ...
                    try {
                        ...
                        if (!d)
                            if (this.s.twitchAuth) {
                                ...
                                throw new GPAuthError_;
                        d = 1 === d ? "t" : "d";
                        const p = JSON.parse(await f(a, this.publicKey))
                          , r = JSON.parse(await f(p[d], c));
