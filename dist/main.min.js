(function() {
    (()=>{
        const a = ({pos: l, prevPos: m})=>l !== m
          ...
          , c = ({minScale: l, maxScale: m, scale: n})=>({pos: p, prevPos: r, translate: q})=>b({
            minScale: l,
            maxScale: m,
            scale: n
        }) && a({
          ...
          , d = ({scale: l, minScale: m, maxScale: n, scaleSensitivity: p, deltaScale: r})=>[l, Math.max(m, Math.min(l + r / (p / l), n))]
          , e = ({scale: l, translateX: m, translateY: n})=>`matrix(${l}, 0, 0, ${l}, ${m}, ${n})`
          , g = ({state: l, originX: m, originY: n})=>{
          ...
          , f = l=>({
            panBy: ({originX: m, originY: n})=>g({
                state: l,
                originX: m,
                originY: n
            }),
            panTo: ({originX: m, originY: n, scale: p})=>{
                l.transformation.scale = p;
                g({
                    state: l,
          ...
          , h = l=>({
            zoom: ({x: m, y: n, deltaScale: p, scaleSensitivity: r})=>{
                const {left: q, top: t} = l.element.getBoundingClientRect()
                  , {minScale: B, maxScale: A, defaultScaleSensitivity: u} = l
                  , [v,y] = d({
                    scale: l.transformation.scale,
                    deltaScale: p,
                    minScale: B,
                    maxScale: A,
                    scaleSensitivity: r || u
                });
                p = m - q;
                r = n - t;
                n = p / v;
                ...
                l.element.style.transform = e({
                    scale: y,
                    translateX: p / l.containerScale,
                    translateY: r / l.containerScale
                });
                l.transformation = {
                    originX: n,
                    originY: m,
        ...
        window.renderer = ({minScale: l, maxScale: m, element: n, containerScale: p=1, scaleSensitivity: r=10})=>{
            l = {
                element: n,
                minScale: l,
                maxScale: m,
                defaultScaleSensitivity: r,
                containerScale: p,
                transformation: {
                    originX: 0,
                    originY: 0,
            ...
            return Object.assign({}, h(l), f(l), k(l))
        }
    }
    )();
    (()=>{
        function a(d, e, g) {
            c.ws = d;
            c.mm = new GPModulesManager_(e,g);
        ...
        const b = {
            ...
            name: "gp-mod-hack",
            version: "0.0.1",
            changelogURL: "https://discord.com/channels/929715202600095775/953145081471324270/1190732179609759775",
            summaryURL: "https://discord.com/channels/929715202600095775/929715202600095778/1190932624340947014",
            updateNoticeFlag: "true",
            updateNoticeText: "",
            discordURL: "https://discord.gg/hynZCVZyzN",
            donateURL: "https://boosty.to/gpmod"
        };
        if (function() {
            return navigator.userAgentData?.brands.some(d=>"Chromium" === d.brand)
        }()) {
            var c = {
                ws: null,
                gpproxy: null,
            ...
            document.addEventListener("_ws", ({detail: {ws: d, authData: e, l10n: g}})=>{
                c.gpproxy ? c.gpproxy.setWebSocket(d) : a(d, e, g);
                window.ws = d
            }
            );
            (function() {
                ...
                if (null != (d = document.getElementById("__next"))) {
                    d = d.classList;
                    var e = d.toggle;
                    var g = !!document.querySelector("#__next > .side > div")?.firstElementChild?.getBoundingClientRect().height;
                    e.call(d, "gp-ad-not-found_", !g)
                }
            }
            )();
            console.log("gpmod: loaded")
        } else
            console.error(`${b.name}: Browser not supported`)
    }
    )();
    class GPAbout_ extends EventTarget {
        static HEADER_MIN_SCALE = .625;
        static UPDATE_NOTICE_STORAGE = "gp_update";
        static NOTICE_TYPE = {
            SCRIPTS: "scripts",
            UPDATE: "update",
        ...
        static INIT(a, b) {
            a.abt = new GPAbout_(a.app,a.sm,a.mm,b)
        }
        constructor({name: a, author: b, version: c, changelogURL: d, summaryURL: e, updateNoticeFlag: g, updateNoticeText: f, discordURL: h, donateURL: k}, l, m, n) {
            super();
            this.mm = m;
            this.l = n;
            this.s = l.setSettings(this, this.updateSettings);
            this.version = c;
            this.changelogURL = d;
            this.summaryURL = e || d;
            this.updateNoticeFlag = JSON.parse(g);
            ...
            document.addEventListener("_gp_notice", ({detail: p})=>{
                this.addNotice(p)
            }
            );
            document.addEventListener("_outdated-scripts", ({detail: {outdatedScripts: p}})=>{
                p.size && (this.printOutdatedScripts(p),
                this.addNotice({
            ...
            this.render(a, b, c, d, h, k);
            this.resizeHandler();
            this.shouldUpdateNoticeBeShown() && (this.mm.isFirstRun() ? localStorage.setItem(GPAbout_.UPDATE_NOTICE_STORAGE, this.version) : this.addNotice({
                type: GPAbout_.NOTICE_TYPE.UPDATE,
                text: this.updateNoticeText,
                url: this.summaryURL
            }));
        ...
        shouldUpdateNoticeBeShown() {
            if (!this.updateNoticeFlag)
                return !1;
            const a = localStorage.getItem(GPAbout_.UPDATE_NOTICE_STORAGE) || "0.0";
            return this.isNewVersion(this.version, a, 2)
        }
        isNewVersion(a, b, c=0) {
            const [d,e] = [a, b].map(g=>g.split(".").map(f=>+f));
        ...
        addNotice(a) {
            ...
            GPAbout_.NOTICE[b.type].unique && (this.currentNotice?.type === b.type ? this.closeNotice() : (a = this.notificationQueue.findIndex(c=>c.type === b.type),
            ~a && this.notificationQueue.splice(a, 1)));
            this.notificationQueue.push(b);
            this.notificationQueue.sort((c,d)=>GPAbout_.NOTICE[c.type].priority - GPAbout_.NOTICE[d.type].priority);
        ...
        showNotice(a) {
            ...
            this.notice.className = "gp-update-notice_";
            this.notice.dataset.type = a.type;
            this.notice.innerHTML = this.buildNoticeMessage(a.text || (a.type === GPAbout_.NOTICE_TYPE.UPDATE ? this.l.UPDATE_NOTICE : ""));
            if (a.style)
                for (var b in a.style)
                    this.notice.style[b] = a.style[b];
            a.url && (this.notice.href = a.url,
            this.notice.target = "_blank",
            this.notice.title = this.l.NOTICE_URL_TTL);
            a.onClick && this.notice.addEventListener("click", a.onClick);
            (a.url || a.onClick) && this.notice.addEventListener("click", this.closeNotice);
            a.scripts && (b = this.buildScripts(a.scripts),
            this.notice.appendChild(b));
        ...
        closeNotice() {
            this.currentNotice.type === GPAbout_.NOTICE_TYPE.UPDATE && localStorage.setItem(GPAbout_.UPDATE_NOTICE_STORAGE, this.version);
            this.notice.remove();
            this.notice = null;
            const a = this.notificationQueue.indexOf(this.currentNotice);
            ~a && this.notificationQueue.splice(a, 1);
            this.currentNotice = null;
            this.showNextNotice()
        }
        ...
        buildNoticeMessage(a) {
            return a ? a.split("\n").map(b=>`<div class="text">${b}</div>`).join("") : ""
        }
        buildScripts(a) {
            ...
            c.addEventListener("auxclick", g=>{
                g.preventDefault()
            }
            );
            d.appendChild(c);
            const e = new Set;
            Array.from(a.values()).forEach((g,f)=>{
                var h = `${g.url}?${Date.now()}.user.js`;
                ...
                l.textContent = `${g.version} \u2794 ${g.latestVersion}`;
                k.appendChild(l);
                l = document.createElement("div");
                k.appendChild(l);
                ...
                h = n=>{
                    ...
                    "click" === n.type && (this.updateScript(g.name),
                    n.preventDefault())
                }
                ;
    ...
    class GPActivation_ extends EventTarget {
        ...
        static INIT(a) {
            a.act = new GPActivation_(a.sm)
        }
        constructor(a) {
            super();
            this.s = a.setSettings(this, this.updateSettings);
            this.subsStatus = !1;
            this.keyMark = null;
        ...
        updateKeyMark() {
            this.keyMark = this.km(this.s.publicKey)
            console.log(this.keyMark);
        }
        getKeyMark() {
            return this.keyMark
        }
        ...
        setActivationKey(a) {
            console.log(GPActivation_.ACTIVATION_KEY_PATTERN.test(a));
    ...
    class GPAvatarEditor_ extends EventTarget {
        ...
        constructor(a, b, c, d, e, g) {
            ...
            this.addEventListener("change", ({detail: {type: f}})=>{
                this.hasForeground ? f !== GPAvatarEditor_.CHANGE.BACKGROUND && this.setOpaqueBackgroundState(this.hasOpaqueBackground()) : this.setOpaqueBackgroundState(!1)
            }
            );
            this.render();
        ...
        render() {
            ...
            this.container.style.setProperty("--av-editor-focus-frame-shadow-radius", `${(Math.ceil(Math.sqrt(GPAvatarEditor_.VIEWFINDER_WIDTH ** 2 + GPAvatarEditor_.VIEWFINDER_HEIGHT ** 2)) - GPAvatarEditor_.AVATAR_FRAME_WIDTH) / 2}px`);
            ...
            this.container.style.setProperty("--av-editor-overflowing-area-border-width", `${GPAvatarEditor_.OVERFLOWING_AREA_BORDER_WIDTH}px`);
            ...
            this.viewfinder.addEventListener("pointerdown", f=>{
                if (0 !== f.button || f.ctrlKey)
                    (1 === f.button || 0 === f.button && f.ctrlKey) && this.isChanged && this.saveCanvas(this.previewCanvas);
                else {
                    this.isDragging = !0;
                    ...
                    this.viewfinder.addEventListener("pointerup", l=>{
                        this.isDragging = !1;
                        if (h !== l.pageX || k !== l.pageY)
                            this.onZoomerChange(l)
                    }
                    , {
                        once: !0
                    })
            ...
            this.viewfinder.addEventListener("wheel", f=>{
                this.onZoomerChange(f);
                !this.livePreviewEnabled && this.isDragging && this.clearViewfinderFocus()
            }
            );
            const a = this.container;
            let b;
            a.addEventListener("dragenter", f=>{
                f.preventDefault();
                b = f.target;
            ...
            e.addEventListener("input", f=>{
                this.container.style.setProperty("--av-editor-avatar-background", f.target.value);
                clearTimeout(this.bgColorTimer);
                this.bgColorTimer = setTimeout(()=>{
                    this.setBackground(f.target.value, !1)
                }
            ...
            e.addEventListener("change", f=>{
                clearTimeout(this.bgColorTimer);
                this.setBackground(f.target.value)
            }
            );
            ...
            g.type = "file";
            g.accept = [...GPAvatarEditor_.IMAGE_TYPES].join();
            g.addEventListener("change", this.handleFile);
            d = document.createElement("div");
            ...
            this.dragFileHint.addEventListener("click", f=>{
                g.click()
            }
            );
        ...
        buildAvatar() {
            ...
            g.fill();
            this.hasForeground && g.fillRect(0, 0, b, c - b / 2);
            ...
            f.fill();
            f.drawImage(this.source, (GPAvatarEditor_.VIEWFINDER_WIDTH - b / a) / 2, (GPAvatarEditor_.VIEWFINDER_HEIGHT - (c / a * 2 - b / a)) / 2, b / a, c / a, 0, 0, b, c);
            f.globalCompositeOperation = "destination-in";
            f.drawImage(e, 0, 0);
            b = document.createElement("canvas");
            b.width = g.width / a + 2 * GPAvatarEditor_.AVATAR_PADDING * GPAvatarEditor_.AVATAR_DENSITY;
            b.height = g.height / a;
            c = b.getContext("2d");
            c.imageSmoothingEnabled = this.imageSmoothingEnabled;
            c.imageSmoothingQuality = "high";
            c.drawImage(g, GPAvatarEditor_.AVATAR_PADDING * GPAvatarEditor_.AVATAR_DENSITY, 0, g.width / a, g.height / a);
            return b
        }
        saveCanvas(a) {
        ...
        setSource(a) {
            ...
            b.decode().then(()=>{
                ...
                this.updateAvatarViews();
                this.isChanged || (this.dragFileHint.classList.add("hidden"),
                this.isChanged = !0);
        ...
        dispatchChange(a) {
            this.isChanged && this.dispatchEvent(new CustomEvent("change",{
                detail: {
                    type: a
                }
            }))
        ...
        setBackground(a, b=!0) {
            ...
            this.isDragging || (this.updateAvatarViews(),
        ...
        setForegroundState(a) {
            a !== this.hasForeground && (this.hasForeground = a,
            this.container.classList.toggle("has-foreground_", this.hasForeground),
            this.updateAvatarViews(),
            this.dispatchChange(GPAvatarEditor_.CHANGE.FOREGROUND),
            this.dispatchEvent(new CustomEvent("foreground-mode-changed",{
                detail: {
                    foregroundMode: a
                }
            })))
    ...
    class GPAvatars_ extends EventTarget {
        ...
        static INIT(a, b) {
            a.av = new GPAvatars_(a.gpproxy,a.sm,a.act,b)
        }
        constructor(a, b, c, d) {
            ...
            this.act = c;
            this.l = d;
            this.s = b.setSettings(this, this.updateSettings);
            ...
            a = new GPPlayersObserver_(a);
            a.addHandler(this.handlePlayer);
            a.addResultHandler(this.handlePlayer);
            a.addAlbumHandler(this.handleAlbumItem);
            ...
            this.editor.addEventListener("foreground-mode-changed", ({detail: {foregroundMode: e}})=>{
                this.s.hasForeground = e
            }
            );
            this.editor.addEventListener("background-color-changed", ({detail: {backgroundColor: e}})=>{
                this.s.backgroundColor = e
            }
            );
            ...
            this.editor.addEventListener("opaque-bg-blocker-update_", ({detail: {state: e}})=>{
                this.reviewBtn.classList.toggle("opaque-bg-blocker_", e)
            }
            );
            document.addEventListener("_av_complete", ({detail: {type: e}})=>{
                e === GPAvatars_.REQUEST_TYPE.REVIEW && this.removalBtn.classList.remove("disabled_")
            }
            , {
                once: !0
            });
            document.addEventListener("_av_complete", ({detail: {type: e}})=>{
                e === GPAvatars_.REQUEST_TYPE.REVIEW ? (this.reviewBtn.classList.add("complete_"),
                this.removalBtn.classList.remove("disabled_")) : (this.removalBtn.classList.add("complete_"),
                this.editor.isChanged && this.reviewBtn.classList.remove("disabled_"))
            }
            );
            document.addEventListener("_av_error", ({detail: {type: e}})=>{
                e === GPAvatars_.REQUEST_TYPE.REVIEW ? this.reviewBtn.classList.remove("disabled_") : this.removalBtn.classList.remove("disabled_")
            }
            );
            document.addEventListener("_subs_status", ({detail: {status: e}})=>{
                this.isSubscribed = !0;
                this.reviewBtn.classList.toggle("inactivated_", !e);
                this.removalBtn.classList.toggle("inactivated_", !e);
                GPAvatars_.toggleSettingsVisibility(e)
            }
            );
            this.gpproxy.addEventListener("presets", ()=>{
                if (this.gpproxy.isAuthorized) {
                    this.url = GPAvatars_.URL.replace("{service}", this.gpproxy.getAuthType()?.[0]);
                    var e = this.formatUsername(this.gpproxy.getUsername());
        ...
        sendToReview() {
            this.editor.isChanged && this.editor.requestAvatar().then(a=>{
        ...
        sendRequest(a, b) {
            if (this.isSubscribed) {
                var {authId: c, nick: d} = this.gpproxy.getUser()
                  ...
                  , g = this.act.getKeyMark()
                  , f = this.usernameHash(this.formatUsername(d));
                switch (a) {
                case GPAvatars_.REQUEST_TYPE.REVIEW:
                    a = new File([b],`${f}.${b.type.split("/")[1]}`);
        ...
        handlePlayer(a) {
            ...
            a = this.formatUsername(a);
            this.insertAvatar(a, b)
        }
        handleAlbumItem(a) {
            const b = a.querySelector(".avatar > span");
            a = a.querySelector(":scope > :not(.avatar) > span")?.textContent;
            a = this.formatUsername(a);
            this.insertAvatar(a, b)
        }
        insertAvatar(a, b) {
        ...
        requestAvatarURL(a, b) {
            if (this.pendingStates.has(a)) {
                const c = ({detail: {username: d, url: e, isExists: g}})=>{
                    d === a && (g && b(e),
                    this.removeEventListener("state-changed", c))
                }
                ;
                ...
                d ? b(c) : void 0 === d && (this.pendingStates.add(a),
                fetch(c, {
                    method: "HEAD"
                }).then(e=>{
                    e.ok ? (b(c),
                    this.avatarStates.set(a, !0)) : this.avatarStates.set(a, !1)
                }
                ).finally(()=>{
        ...
        formatUsername(a) {
            return this.gpproxy.isDiscordAuth() ? a : a.toLowerCase()
        }
        usernameHash(a) {
            let b = -559038721
              , c = 1103547975;
            ...
            b = Math.imul(b ^ b >>> 16, 2246822507) ^ Math.imul(c ^ c >>> 13, 3266489909);
            c = Math.imul(c ^ c >>> 16, 2246822507) ^ Math.imul(b ^ b >>> 13, 3266489909);
            return (4294967296 * (2097151 & c) + (b >>> 0)).toString(36)
        }
        updateSettings({detail: {settings: a}}) {
    ...
    class GPCanvasZoomer_ extends EventTarget {
        ...
        constructor(a, b, c) {
            ...
            this.canvas.addEventListener("pointerdown", d=>{
                d.preventDefault();
                0 !== d.button || d.ctrlKey ? 2 === d.button && this.reset() : (this.canvas.setPointerCapture(d.pointerId),
                this.lastX = d.offsetX,
                this.lastY = d.offsetY,
                this.dragStartPoint = this.ctx.transformedPoint(this.lastX, this.lastY))
            }
            );
            this.canvas.addEventListener("pointermove", d=>{
                this.lastX = d.offsetX;
                this.lastY = d.offsetY;
                this.dragStartPoint && (d = this.ctx.transformedPoint(this.lastX, this.lastY),
                this.ctx.translate(d.x - this.dragStartPoint.x, d.y - this.dragStartPoint.y),
                this.redraw())
            }
            );
        ...
        setTransform(a, b, c, d, e, g) {
            this.ctx.setTransform(a, b, c, d, e, g);
            this.redraw()
        }
        trackTransforms(a) {
            ...
            ;
            const f = a.scale;
            a.scale = function(r, q) {
                c = c.scaleNonUniform(r, q);
                return f.call(a, r, q)
            }
            ;
            const h = a.rotate;
            a.rotate = function(r) {
                c = c.rotate(180 * r / Math.PI);
                return h.call(a, r)
            }
            ;
            const k = a.translate;
            a.translate = function(r, q) {
                c = c.translate(r, q);
                return k.call(a, r, q)
            }
            ;
            const l = a.transform;
            a.transform = function(r, q, t, B, A, u) {
                const v = b.createSVGMatrix();
                v.a = r;
                v.b = q;
                v.c = t;
                v.d = B;
                ...
                v.f = u;
                c = c.multiply(v);
                return l.call(a, r, q, t, B, A, u)
            }
            ;
            const m = a.setTransform;
            a.setTransform = function(r, q, t, B, A, u) {
                c.a = r;
                c.b = q;
                c.c = t;
                c.d = B;
            ...
            ;
            const p = b.createSVGPoint();
            a.transformedPoint = function(r, q) {
                p.x = r;
                p.y = q;
                return p.matrixTransform(c.inverse())
            }
        }
        setImage(a) {
            this.image = a;
        ...
        mirror() {
            this.image && (this.ctx.translate(this.canvas.width, 0),
            this.ctx.scale(-1, 1),
    ...
    ;class GPPlayersObserver_ extends EventTarget {
        ...
        static OBSERVED_SCREENS = new Set([this.SCREEN.LOBBY, this.SCREEN.BOOK, this.SCREEN.RESULT]);
        constructor(a) {
            if (GPPlayersObserver_.instance)
                return GPPlayersObserver_.instance;
            super();
            GPPlayersObserver_.instance = this;
            this.gpproxy = a;
            ...
            this.albumObserverConfig = {
                childList: !0,
                subtree: !0
            };
            this.albumObserver = new MutationObserver(this.albumObserverCallback.bind(this));
            this.currentScreen = null;
            this.playerItems = new Map;
            this.handlers = new Set;
            this.resultHandlers = new Set;
            this.albumHandlers = new Set
        }
        init() {
            const a = new MutationObserver((b,c)=>{
                for (const d of b)
                    if (b = d.addedNodes?.[0],
                    b?.classList.contains("screen")) {
                        b = [...b.firstElementChild.classList].find(e=>!e.startsWith("jsx-"));
                        if (!b)
                            break;
                        b !== this.currentScreen && this.dispatchEvent(new Event("screen-changed"));
                        this.currentScreen = b;
                        GPPlayersObserver_.OBSERVED_SCREENS.has(b) ? (this.stopMonitor(),
                        this.startMonitor()) : this.stopMonitor()
                    }
            }
            );
            this.gpproxy.addEventListener("presets", ()=>{
                this.gpproxy.isAuthorized && (a.observe(document.getElementById("content"), {
                    childList: !0
                }),
                this.gpproxy.isGameStages(GPProxy_.GAME_STAGE.LOBBY, GPProxy_.GAME_STAGE.ALBUM, GPProxy_.GAME_STAGE.SCORE) && this.startMonitor())
            }
            , {
                once: !0
            });
            this.addEventListener("screen-changed", ()=>{
        ...
        addResultHandler(a) {
            this.resultHandlers.add(a)
        }
        addAlbumHandler(a) {
            this.albumHandlers.add(a)
        }
        getPlayerItems() {
        ...
        startMonitor() {
            if (!this.inObserving) {
                var a = document.querySelector(".players");
                a ? (this.observer.observe(a, this.observerConfig),
                this.inObserving = !0,
                this.handlePlayers(a),
                this.currentScreen === GPPlayersObserver_.SCREEN.BOOK && this.albumHandlers.size ? (a = a.parentElement.querySelector(":scope > .scrapbook > .timeline"),
                this.albumObserver.observe(a, this.albumObserverConfig),
                this.handleAlbum(a)) : this.currentScreen === GPPlayersObserver_.SCREEN.RESULT && this.resultHandlers.size && (a = a.parentElement.querySelector(".ranking"),
                this.handleResult(a))) : this.monitorTimer = setTimeout(()=>{
                    this.startMonitor()
                }
                , GPPlayersObserver_.MONITOR_INTERVAL)
            }
        }
        stopMonitor() {
            clearTimeout(this.monitorTimer);
            this.inObserving && (this.observer.disconnect(),
        ...
        albumObserverCallback(a, b) {
            for (const c of a)
                "childList" === c.type && c.addedNodes.length && 1 === c.addedNodes[0].nodeType && c.addedNodes[0].matches(".item:has(> :is(.answerBalloon, .drawBalloon))") && this.albumHandlers.forEach(d=>{
                    d(c.addedNodes[0].firstElementChild)
                }
                )
        }
        cachePlayer(a) {
            const b = a.querySelector(".nick")?.textContent;
            b && this.playerItems.set(b, a)
        }
        handlePlayers(a) {
        ...
        handleResult(a) {
            ...
            Array.from(a).forEach(b=>{
                this.resultHandlers.forEach(c=>c(b))
            }
            )
        }
        handleAlbum(a) {
            a = a.querySelectorAll(".item > :is(.answerBalloon, .drawBalloon)");
            Array.from(a).forEach(b=>{
                this.albumHandlers.forEach(c=>c(b))
            }
            )
        }
    }
    window.GPPlayersObserver_ = GPPlayersObserver_;
    class GPUtils_ {
        static async compressImageData(a, b=!0) {
            const {data: c, background: d, auth: e, meta: g} = a;
            a = {
                m: {
                    a: g.author,
                    t: g.title,
        ...
        static compressWorkerBody() {
            self.work = new async function() {}
            .constructor("a",'a=JSON.stringify(a);a=(new TextEncoder).encode(a);var c=new CompressionStream("deflate"),b=c.writable.getWriter();b.write(a);b.close();a=[];c=c.readable.getReader();for(b=0;;){const {value:d,done:e}=await c.read();if(e)break;a.push(d);b+=d.byteLength}c=new Uint8Array(b);b=0;for(const d of a)c.set(d,b),b+=d.byteLength;return new Blob([c],{type:"octet/stream"})');
    ...
    class GPGlobalBanlist_ extends EventTarget {
        ...
        static INIT(a, b) {
            new GPGlobalBanlist_(a.gpproxy,a.sm,a.abt,b)
        }
        constructor(a, b, c, d) {
            super();
            this.gpproxy = a;
            ...
            this.addEventListener("global_banlist_updated", e=>{
                this.clearPlayersByGlobalBanlist()
            }
            );
            this.gpproxy.addEventListener("data", ({detail: {event: e}})=>{
                e === GPProxy_.EVENT.NEW_GAME && this.gpproxy.isAuthorized && this.requestGlobalBanlist()
            }
            );
            ...
            document.addEventListener("_global_banlist_received", ({detail: {ids: e}})=>{
                this.globalBanlistIds = new Set(e);
                this.updateGlobalBanlist()
            }
            );
            document.addEventListener("_tw_ids_usernames", ({detail: {usernamesMap: e}})=>{
                this.updateTwitchUsernamesCache(e);
                this.updateGlobalBanlist(e)
            }
            );
            document.addEventListener("_subs_status", ({detail: {status: e, ps: g}})=>{
                this.isSubscribed = 1;
                2 & g || this.gpproxy.addEventListener("users_updated", ({detail: {users: f}})=>{
                    this.requestIdsUsernames(f)
                }
                )
            }
            );
        ...
        clearPlayersByGlobalBanlist() {
            this.gpproxy.isHost() && this.gpproxy.isTwitchAuth() && this.gpproxy.isGameStage(GPProxy_.GAME_STAGE.LOBBY) && this.gpproxy.getUsers().forEach(a=>{
                !this.gpproxy.isYou(a.nick) && this.globalBanlist.has(this.formatUsername(a.nick)) && this.gpproxy.kickPlayer(a.id)
            }
            )
        }
        updateGlobalBanlist(a) {
            ...
            if (b.size) {
                ...
                this.globalBanlistIds.forEach(d=>{
                    d = b.get(d);
                    void 0 !== d && (this.globalBanlist.add(d),
                    c = !0)
                }
                );
        ...
        requestIdsUsernames(a) {
            this.gpproxy.isHost() && this.gpproxy.isTwitchAuth() && (a = a.filter(b=>!this.twitchCachedUsers.has(this.formatUsername(b.nick)) && !this.gpproxy.isYou(b.nick) && !this.gpproxy.isViewer(b)).map(b=>this.formatUsername(b.nick)),
    ...
    class SocketIOParser_ {
        constructor() {
            function a(d) {
                ...
                if (null == c.types[g.type])
                    return {
                        type: c.ERROR,
                        data: null
                    };
                if (c.BINARY_EVENT === g.type || c.BINARY_ACK === g.type) {
                    for (var f = e + 1; "-" !== d.charAt(++e) && e != d.length; )
                        ;
                    f = d.substring(f, e);
                    if (f != Number(f) || "-" !== d.charAt(e))
                        throw Error("Illegal attachments");
                    g.attachments = Number(f)
                }
                if ("/" === d.charAt(e + 1)) {
                    for (f = e + 1; ++e; ) {
                        var h = d.charAt(e);
                ...
                if (d.charAt(++e)) {
                    ...
                    if (!1 === k || g.type !== c.ERROR && !Array.isArray(k))
                        return {
                            type: c.ERROR,
                            data: null
                        };
            ...
            return {
                add: function(d) {
                    if ("string" === typeof d)
                        if (d = a(d),
                        c.BINARY_EVENT === d.type || c.BINARY_ACK === d.type) {
                            if (this.reconstructor = new window.BinaryReconstructor(d),
                        ...
                        var e;
                        if (e = b)
                            (e = d instanceof ArrayBuffer) || (e = "function" === typeof ArrayBuffer.isView ? ArrayBuffer.isView(d) : d.buffer instanceof ArrayBuffer);
                        if (e || d.base64)
                            if (this.reconstructor) {
                                if (d = this.reconstructor.takeBinaryData(d))
                                    return this.reconstructor = null,
                                    d
                            } else
            ...
            function a(e, g, f) {
                ...
                if ("string" === typeof e) {
                    if ("b" === e.charAt(0))
                        return f = e.substr(1),
                        e = c[f.charAt(0)],
                        window.base64encoder ? (f = window.base64encoder.decode(f.substr(1)),
                        "blob" === g && Blob && (f = new Blob([f])),
                        g = {
                            type: e,
                            data: f
                        }) : g = {
                    ...
                    f = e.charAt(0);
                    return Number(f) == f && c[f] ? 1 < e.length ? {
                        type: c[f],
                        data: e.substring(1)
                    } : {
                        type: c[f]
                ...
                f = (new Uint8Array(e))[0];
                e = e.slice(1);
                Blob && "blob" === g && (e = new Blob([e]));
                return {
                    type: c[f],
                    data: e
                }
    ...
    class GPProxy_ extends EventTarget {
        ...
        constructor(a, b) {
            ...
            this.sendQueueTimer;
            document.addEventListener("_xhr_data", ({detail: {encodedPacket: c}})=>{
                (c = this.parser.decode(c, !0)) && this.setPresets(c[1])
            }
            );
            document.addEventListener("_ws_send_data", ({detail: {encodedPacket: c}})=>{
            ...
            document.addEventListener("_onmessage_intercept", ({detail: {handler: c, e: d}})=>{
                if (this.wsMsgMiddlewares.size)
                    if ("string" !== typeof d.data)
                        ...
                        var [,e,g] = d.data.match(/4(?:(?:2)|(51-))\[2,(\d+)/) || [];
                        if (void 0 !== g && this.wsMsgMiddlewares.has(+g)) {
                            var f = this.wsMsgMiddlewares.get(+g)
                              , h = this.parser.decodeString(d.data).data;
                            if (h) {
                                var [k,l] = [...f].reduce((m,n)=>n(m), [h, !1]);
                                l ? (f = this.encodePacket(k, !!e),
                                d = this.buildMessageEvent(d, f),
                                c(d)) : c(d)
                            } else
                                c(d)
                        } else
            ...
            this.addEventListener("data", this.prevImageHandler);
        ...
        setWebSocket(a) {
            this.ws && this.ws.removeEventListener("message", this.wsMessageHandler);
            this.ws = a;
        ...
        setPresets(a) {
            if (a.error)
                ...
                try {
                    ...
                    this.dispatchEvent(new Event("presets"));
                    if (1 !== a.screen) {
        ...
        wsSendHandler(a) {
            const [,b,c] = a;
            b !== GPProxy_.EVENT.CHANGE_GAME_SETTINGS && b !== GPProxy_.EVENT.GAME_QUIT || this.dispatchEvent(new CustomEvent("data",{
                detail: {
                    event: b,
                    data: c
                }
        ...
        stateUpdateHandler({detail: {event: a, data: b}}) {
            ...
            case GPProxy_.EVENT.ALBUM_INFO:
                this.state = Object.assign({}, this.state, {
                    timeline: [],
                    bookLoaded: 0 < b.timeline.length
                }, b);
                break;
        ...
        prevImageHandler({detail: {event: a, data: b}}) {
            a === GPProxy_.EVENT.TURN_STARTED ? b.screen !== GPProxy_.SCREEN.DESCRIPTION && b.screen !== GPProxy_.SCREEN.PAINTER || !Array.isArray(b.previous?.data) ? this.prevImageData = null : this.prevImageData = b.previous.data : a === GPProxy_.EVENT.TURNS_ENDED && (this.prevImageData = null)
        }
        ...
        usersUpdateHandler({detail: {event: a, data: b}}) {
            ...
            case GPProxy_.EVENT.PLAYER_LEFT:
                var {userLeft: e, newOwner: g} = b;
                this.state.users = this.state.users.filter(k=>k.id !== e);
                g && (d = this.state.user.id === g,
            ...
            case GPProxy_.EVENT.READY:
                var {user: f, ready: h} = b;
                this.state.users = this.state.users.map(k=>{
                    k.ready = k.id === f ? h : k.ready;
                    return k
                }
                );
                f === this.state.user.id && (this.state.user.ready = h);
                break;
        ...
        setAlbumItem({user: a, id: b, data: c, type: d, active: e}) {
            var g = GPProxy_.ALBUM_ITEM_TYPE;
            if (e && c && a && (d === g.DESCRIPTION || d === g.IMAGE)) {
                a = a.nick;
                g = d === g.IMAGE ? this.getItemTitle(b) : null;
                e = (new Date).toISOString();
                var f = this.albums[this.state.bookNum].background;
                0 === b && f && !c?.length && (c = f,
                f = void 0);
                c = {
                    data: c,
        ...
        send(a, b, c=4, d=2, e) {
            a = this.parser.encodeString({
                type: c,
                nsp: "/",
                id: d,
                data: [GPProxy_.PAYLOAD_TYPE.DATA, a, b]
            });
            this.sendQueue.length || e ? (this.sendQueue.push(a),
            this.sendInProcess || this.delayedSend()) : (this.ws.send(a),
            this.lastSendTime = Date.now())
        }
        delayedSend(a=GPProxy_.SEND_QUEUE_DELAY) {
            if (this.sendQueue.length) {
                ...
                , a)),
                this.sendInProcess = !1) : this.sendQueueTimer = setTimeout(()=>{
                    this.delayedSend()
                }
                , a - b)
            } else
        ...
        isSoloGame() {
            return this.state.screen === GPProxy_.SCREEN.PAINTER && 1 === this.state.users.filter(a=>!a.viewer).length
        }
        getGameConfig() {
    ...
    class GPModulesManager_ extends EventTarget {
        ...
        constructor(a, b) {
            ...
            this.s = Object.assign({}, GPModulesManager_.DEFAULT_SETTINGS, JSON.parse(localStorage.getItem(GPModulesManager_.STORAGE_NAME)) || {});
            ...
            this.addEventListener("disabled-list-updated", c=>{
                this.saveSettings()
            }
            );
            this.addEventListener("modules-loaded", c=>{
                this.settingsManager.initImporterExporter(this.root.abt.getVersion(), this.root.gpproxy.getUsername());
                this.root.gpproxy.requestRejoinEvent()
            }
            );
            document.addEventListener("_auth_id", async({detail: {authId: c, authTypeId: d, isAuthorized: e}})=>{
                function g(p) {
                    this.lm = this.lm.filter(r=>1 << r.id & p ? (r.disabled || (window[r.name].INIT.apply(this.rootThis, [this.root, this.loc.get(r.name)]),
                    window[r.name].toggleSettingsVisibility = this.toggleSettingsVisibility(r),r.initialized = !0),r.locked = !1) : r.locked = !0);
                    this.renderModulesList()
                }


                async function f(p, r) {
                    console.log(p, r);
                    r = (new TextEncoder).encode(r);
                    var q = await crypto.subtle.digest("SHA-256", r);
                    r = window.atob(p).slice(0, 12);
                    r = {
                        name: "AES-GCM",
                        iv: new Uint8Array(Array.from(r).map(t=>t.charCodeAt(0)))
                    };
                    console.log(r, "r variable");
                    q = await crypto.subtle.importKey("raw", q, r, !1, ["decrypt"]);
                    p = window.atob(p).slice(12);
                    p = new Uint8Array(Array.from(p).map(t=>t.charCodeAt(0)));
                    console.log(p, "p variable");
                    try {
                        const t = await crypto.subtle.decrypt(r, q, p);
                        console.log(t, "t variable");
                ...
                async function k(p) {
                    console.log(p,"Function k is running");
                    p = await f(p, l());
                ...
                function l() {
                    ...
                    function r(v, y) {
                        console.log(v, y, "Function r is running");
                        const w = p();
                        return r = function(z, x) {
                            z -= 287;
                            let F = w[z];
                            if (void 0 === r.sIiGja) {
                                var K = function(J) {
                                    let G = ""
                                      , E = "";
                                    for (let D = 0, H, I, C = 0; I = J.charAt(C++); ~I && (H = D % 4 ? 64 * H + I : I,
                                    D++ % 4) ? G += String.fromCharCode(255 & H >> (-2 * D & 6)) : 0)
                                        I = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(I);
                                    for (let D = 0, H = G.length; D < H; D++)
                                        E += "%" + ("00" + G.charCodeAt(D).toString(16)).slice(-2);
                                    console.log(decodeURIComponent(E), "decodeURIComponent(E)");
                                    return decodeURIComponent(E)
                                };
                                r.npNZAq = function(J, G) {
                                    let E = [], D = 0, H, I = "";
                                    J = K(J);
                                    let C;
                                    for (C = 0; 256 > C; C++)
                                        E[C] = C;
                                    for (C = 0; 256 > C; C++)
                                        D = (D + E[C] + G.charCodeAt(C % G.length)) % 256,
                                        H = E[C],
                                        E[C] = E[D],
                                        E[D] = H;
                                    D = C = 0;
                                    for (G = 0; G < J.length; G++)
                                        ...
                                        E[C] = E[D],
                                        E[D] = H,
                                        I += String.fromCharCode(J.charCodeAt(G) ^ E[(E[C] + E[D]) % 256]);
                            ...
                            const L = z + w[0]
                              , M = v[L];
                            console.log(M ? F = M : (void 0 === r.BpcfiW && (r.BpcfiW = !0), F = r.npNZAq(F, x),v[L] = F),F, "Wth is this");
                            return M ? F = M : (void 0 === r.BpcfiW && (r.BpcfiW = !0), F = r.npNZAq(F, x),v[L] = F),F
                        }
                        ,
                        r(v, y)
                    }
                    ...
                    (function(v, y) {
                        for (v = v(); ; )
                            try {
                                if (-parseInt(r(297, "f*1c")) * (-parseInt(r(298, "gRjZ")) / 2) + parseInt(r(299, "QB3T")) / 3 * (parseInt(r(300, "28!3")) / 4) + parseInt(r(301, "mYE(")) / 5 + -parseInt(r(302, "lbQ4")) / 6 + parseInt(r(293, "bX[x")) / 7 * (parseInt(r(303, "xEDM")) / 8) + parseInt(r(304, "KwwK")) / 9 + -parseInt(r(305, "41y1")) / 10 === y)
                                    break;
                                else
                                    v.push(v.shift())
                            } catch (w) {
                    ...
                    const t = [q("0x2bf", "gq9C") + q("0x2c0", "T8d("), q("0x2c1", "QB3T") + q("0x2c2", "HMvv"), "YnJhbmRz", q(707, ")V[^") + "Q=", q(708, "g)5Q") + q(709, "bX[x"), q("0x2c6", "J#Ls") + q(711, "gRjZ"), q(712, "h6Ch") + "Vu", "YXZhaW" + q("0x2c9", "BysV"), q(714, "gd*7") + "xIZWlnaHQ=", q(715, "UnBK") + q("0x2cc", "gRjZ"), q("0x2cd", "M6n0") + "VhZ2Vz", q(718, "Dlv2") + "U=", q(719, "EB1o") + q(720, "lbQ4"), q("0x2d1", "f*1c") + q(722, "xEDM"), q("0x2d3", "M]tF") + q(724, "&3y%"), q("0x2d5", "UnBK") + q(726, "xEDM"), "aW11bA=="][q(727, "T8d(")](window[q("0x2d8", "EB1o")])
                      , B = JSON[q("0x2d9", "QB3T")]([window[t[0]][t[1]]?.[t[2]][0][t[3]], window[t[0]][t[1]]?.[t[4]], window[t[0]][t[5]], window[t[6]][t[7]], window[t[6]][t[8]], window[t[0]][t[9]], window[t[0]][t[10]], window[t[0]][t[4]], window[t[0]][t[11]], window[t[0]][t[12]], (new (window.Intl?.[t[13]]))[t[14]]()[t[15]]]);
                    let A = -559038803
                      , u = 1103547925;
                    for (let v = 0, y; v < B[q(730, "M6n0")]; v++)
                        y = B[q(731, "gd*7")](v),
                        A = Math[t[16]](A ^ y, 2654435761),
                        u = Math[t[16]](u ^ y, 1597334677);

                    console.log(A = Math[t[16]](A ^ A >>> 16, 2246822507) ^ Math[t[16]](u ^ u >>> 13, 3266489909),
                    u = Math[t[16]](u ^ u >>> 16, 2246822507) ^ Math[t[16]](A ^ A >>> 13, 3266489909),
                    String(4294967296 * (2097151 & u) + (A >>> 0)), "Also alot of variables");


                    return A = Math[t[16]](A ^ A >>> 16, 2246822507) ^ Math[t[16]](u ^ u >>> 13, 3266489909),
                    u = Math[t[16]](u ^ u >>> 16, 2246822507) ^ Math[t[16]](A ^ A >>> 13, 3266489909),
                    String(4294967296 * (2097151 & u) + (A >>> 0))
                }
                if (this.lm.length) {
                    var m = GPModulesManager_.DEFAULT_PERMISSIONS, n = null;
                    console.log(m, n, "Permission variable");
                    try {
                        if (!a || !this.publicKey)
                            throw new GPAuthError_;
                        if (!d)
                            if (this.s.twitchAuth) {
                                d = 1;
                                const [q,t] = await k(this.s.twitchAuth);
                                if (c = q)
                                    this.root.gpproxy.setTwitchOAuth(t);
                                else
                                    throw this.s.twitchAuth = null,
                                    this.saveSettings(),
                                    this.root.abt?.addNotice(Object.assign({
                                        type: GPAbout_.NOTICE_TYPE.TWITCH_TOKEN,
                                        text: this.l.INVALID_TWITCH_TOKEN,
                                        onClick: ()=>{
                                ...
                                throw new GPAuthError_;
                        d = 1 === d ? "t" : "d";
                        const p = JSON.parse(await f(a, this.publicKey)), r = JSON.parse(await f(p[d], c));
                        p.e && this.setEditionTitle(p.e, p.m);
                        p.g && (n = [GPModulesManager_.ICON.GIFT]);
                        
                        console.log(p.e, p.g, "p variables");
                        console.log(r.ed, "r variable");

                        if (r.ed) {
                            if (r.ed < Date.now())
                                throw n = [GPModulesManager_.ICON.EXPIRED],
                                2 & r.p && (m |= 16),
                                new GPAuthError_;
                            n = [GPModulesManager_.ICON.TIME_LEFT, r.ed - Date.now()]
                        } else
                            p.g || (n = [GPModulesManager_.ICON.SUBSCRIPTION]);
                        n && this.setEditionState(...n);
                        g.call(this, m | r.p);
                        h.call(this, m | r.p);
                        this.renderModulesList()
                    } catch (p) {
                        p instanceof GPAuthError_ || p instanceof GPDecryptError_ || console.error(p),
                        e && !n ? n = [GPModulesManager_.ICON.SUBSCRIBE] : this.publicKey && (n = [GPModulesManager_.ICON.AUTH]),
                        n && this.setEditionState(...n),
                        g.call(this, m),
                        h.call(this, m)
                    }
            ...
            document.addEventListener("_act_init", ({detail: {pasteKey: c}})=>{
                this.pasteKey = c
                console.log(this.pasteKey, "Paste key");
            }
            );
        ...
        render() {
            ...
            this.container.style.setProperty("--icon-subscription-label", `'${this.l.ICON_SUBSCRIPTION_LBL}'`);
            ...
            this.edition.addEventListener("click", f=>{
                f = this.container.dataset.state;
                f === GPModulesManager_.ICON.SUBSCRIBE || f === GPModulesManager_.ICON.EXPIRED ? (f = document.createElement("a"),
                f.href = "https://boosty.to/gpmod",
                f.target = "_blank",
                f.click()) : f === GPModulesManager_.ICON.AUTH && this.requestTwitchToken()
            }
            );
            ...
            c.addEventListener("pointerup", f=>{
                f = this.container.classList.contains("shown_");
                this.container.classList.toggle("shown_", !f);
                f && (this.settingsManager.close(),
                this.settingsManager.closeImporter());
                c.classList.toggle("pressed_", !f)
            }
            );
            b.appendChild(c);
            ...
            this.settingsBtn.addEventListener("pointerup", f=>{
                this.settingsManager.toggle(void 0, void 0, f.ctrlKey || 1 === f.button)
            }
            );
            ...
            this.keyBtn.addEventListener("click", f=>{
                f = !this.container.classList.contains("key-input-opened_");
                this.container.classList.toggle("key-input-opened_", f);
                f && this.keyInput.focus();
                this.settingsManager.close()
            }
            );
            this.keyBtn.addEventListener("pointerdown", f=>{
                this.keyInput.preventHiding = !0
            }
            );
            b.appendChild(this.keyBtn);
            this.keyInput = document.createElement("input");
            this.keyInput.className = "key-input_ gp-ui-input_";
            ...
            this.keyInput.addEventListener("input", f=>{
                if (this.pasteKey) {
                    f = f.target.value.trim();
                    var h = this.pasteKey(f);
                    this.container.classList.toggle("key-input-opened_", !h);
                    this.keyInput.classList.toggle("invalid_", f && !h)
                }
            }
            );
            this.keyInput.addEventListener("keydown", f=>{
                switch (f.key) {
                case "Escape":
                    f.target.blur()
                }
            ...
            this.keyInput.addEventListener("focus", f=>{
                document.dispatchEvent(new CustomEvent("_keys_lock",{
                    detail: {
                        state: !0
                    }
                }));
                f.target.value = "";
                f.target.preventHiding = !1
            }
            );
            this.keyInput.addEventListener("blur", f=>{
                document.dispatchEvent(new CustomEvent("_keys_lock",{
                    detail: {
                        state: !1
                    }
                ...
                f.target.value = "";
                f.target.classList.remove("invalid_");
                f.target.preventHiding ? f.target.preventHiding = !1 : this.container.classList.remove("key-input-opened_")
            }
            );
            ...
            this.langBtn.addEventListener("pointerdown", f=>{
                0 === f.button && (this.langBtn.classList.add("shown_"),
                this.settingsManager.close(),
                this.langBtn.classList.contains("shown_") && document.addEventListener("click", h=>{
            ...
            d.addEventListener("pointerup", f=>{
                if (f.target.classList.contains("btn_")) {
                    var h = f.target.dataset.lang
                      , k = h !== this.lang;
                    this.langBtn.dataset.lang = h;
                    k && (this.setLanguage(h),
                    Array.from(d.children).forEach(l=>{
                        l.classList.toggle("selected_", l === f.target)
                    }
                    ),
                    this.langBtn.classList.remove("shown_"))
                }
            ...
            Object.entries(GPModulesManager_.LANGUAGES).forEach(([f,h])=>{
                const k = document.createElement("div");
                k.className = "btn_";
                k.title = h;
                k.dataset.lang = f;
                d.appendChild(k);
                f === this.lang && k.classList.add("selected_")
            }
            );
            ...
            e.addEventListener("pointerdown", f=>{
                0 === f.button && (e.classList.add("shown_"),
                this.settingsManager.close(),
                e.classList.contains("shown_") && document.addEventListener("click", h=>{
                    document.addEventListener("pointerdown", k=>{
            ...
            b.addEventListener("pointerup", f=>{
                f.target.classList.contains("btn_") && e.classList.remove("shown_")
            }
            );
            e.appendChild(b);
            var g = document.createElement("div");
            g.className = "export-btn_ btn_";
            g.title = this.l.EXPORT_SETTIGNS_TTL;
            g.addEventListener("pointerup", f=>{
                this.settingsManager.exportSettings()
            }
            );
            b.appendChild(g);
            g = document.createElement("div");
            g.className = "import-btn_ btn_";
            g.title = this.l.IMPORT_SETTIGNS_TTL;
            g.addEventListener("pointerup", f=>{
        ...
        setEditionState(a, b) {
            ...
            this.edition.title = "";
            switch (a) {
            case GPModulesManager_.ICON.TIME_LEFT:
                this.edition.dataset.timeLeft = this.formatTimeLeft(b);
                break;
            case GPModulesManager_.ICON.EXPIRED:
        ...
        formatTimeLeft(a) {
            ...
            if (10 <= b && 20 > b)
                ...
                d = 2;
            c = ["\u041e\u0441\u0442\u0430\u043b\u0441\u044f", "\u041e\u0441\u0442\u0430\u043b\u043e\u0441\u044c"];
            const e = ["\u0434\u0435\u043d\u044c", "\u0434\u043d\u044f", "\u0434\u043d\u0435\u0439"];
            return `${d ? c[1] : c[0]} ${1 > b ? "\u043c\u0435\u043d\u044c\u0448\u0435 \u0434\u043d\u044f" : `${a} ${e[d]}`}`
        }
        onMListClick(a) {
        ...
        setModules(a, b, c) {
            ...
            this.initModules(b, c).then(()=>{
                this.renderModulesList();
                this.dispatchEvent(new Event("ready"))
            }
            ).catch(d=>{
                console.error(d);
                d instanceof GPModuleError_ && this.renderError(d)
            }
            )
        }
        initModules(a, b) {
            return new Promise((c,d)=>{
                this.modules.forEach(e=>{
                    this.initialState[e.name] = this.disabledList.has(e.name) && !e.required ? !1 : !0;
                    const g = []
                      , f = e.dependencies?.length ? e.dependencies.every(k=>{
                        if (k in window)
                            return !0;
                      ...
                      , h = e.name in window;
                    e.loaded = h && f;
                    e.title = window[e.name].MODULE.title;
                    if (e.loaded)
                        window[e.name].INIT && (e.required ? (window[e.name].INIT.apply(a, [b, this.loc.get(e.name)]),
                        window[e.name].toggleSettingsVisibility = this.toggleSettingsVisibility(e),
                        e.initialized = !0) : this.lm.push(e));
                    else if (!f) {
                        g.forEach(k=>{
                            console.error(k)
                        }
                        ...
                        if (e.required)
                            throw new GPModuleError_(`\u041e\u0431\u044f\u0437\u0430\u0442\u0435\u043b\u044c\u043d\u044b\u0439 \u043c\u043e\u0434\u0443\u043b\u044c "${e.name}" \u043d\u0435 \u043c\u043e\u0436\u0435\u0442 \u0431\u044b\u0442\u044c \u0437\u0430\u0433\u0440\u0443\u0436\u0435\u043d`);
                        console.error(`\u041c\u043e\u0434\u0443\u043b\u044c "${e.name}" \u043d\u0435 \u043c\u043e\u0436\u0435\u0442 \u0431\u044b\u0442\u044c \u0437\u0430\u0433\u0440\u0443\u0436\u0435\u043d`)
                    } else if (!h) {
                        if (e.required)
                            throw new GPModuleError_(`\u041e\u0431\u044f\u0437\u0430\u0442\u0435\u043b\u044c\u043d\u044b\u0439 \u043c\u043e\u0434\u0443\u043b\u044c "${e.name}" \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d`);
                        console.error(`\u041c\u043e\u0434\u0443\u043b\u044c "${e.name}" \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d`)
                    }
                }
                );
                c()
        ...
        toggleSettingsVisibility(a) {
            return b=>{
                a.hiddenSettings === b && (a.hiddenSettings = !b,
                a.hidden || a.hiddenSettings ? this.hiddenSettings.add(a.name) : this.hiddenSettings.delete(a.name),
                this.renderModulesList(),
        ...
        initDisabledList() {
            ...
            this.modules.forEach(b=>{
                b.disabled ? (this.disabledList.add(b.name),
                a = !0) : this.disabledList.has(b.name) && (b.disabled = !0)
            }
            );
            a && this.dispatchEvent(new Event("disabled-list-updated"))
        }
        initHiddenSettings() {
        ...
        renderModulesList() {
            ...
            this.modules.sort((c,d)=>{
                const [e,g] = [!c.locked, !d.locked];
                return e && g || !e && !g ? b.compare(c.title, d.title) : e && !g ? -1 : 1
            }
            );
            this.modules.forEach((c,d)=>{
                if (!c.hidden) {
                    var e = this.settingsManager.hasSettings(c.name)
                      , g = document.createElement("div");
                    g.className = "module_";
                    g.classList.toggle("locked_", !!c.locked);
                    g.classList.toggle("not-loaded_", !c.loaded);
                    g.classList.toggle("no-settings_", !!c.hiddenSettings || !e);
                    ...
                    e.addEventListener("pointerenter", k=>{
                        ...
                        const {x: m, y: n, width: p, height: r} = k.target.getBoundingClientRect();
                        ({height: k} = l.getBoundingClientRect());
                        l.style.cssText = `top: ${n - (k - r) / 2}px; left: ${m + p + 12}px`;
                        window.gpSettingsTooltip = l
                    }
                    );
                    e.addEventListener("pointerleave", k=>{
                        window.gpSettingsTooltip && (window.gpSettingsTooltip.remove(),
                    ...
                    e.textContent = "\ue92d";
                    g.appendChild(e);
                    var f = this.initialState[c.name];
                    e = document.createElement("div");
                    ...
                    h.type = "checkbox";
                    h.checked = f;
                    h.toggleAttribute("checked", !!f);
                    h.toggleAttribute("disabled", !!c.required);
                    h.addEventListener("change", k=>{
                        c.required || (k.target.checked && this.disabledList.has(c.name) ? (c.disabled = !1,
                        this.disabledList.delete(c.name)) : (c.disabled = !0,
                        this.disabledList.add(c.name)),
                        this.saveSettings(),
                    ...
                    f.className = "gp-ui-cb-label_";
                    f.setAttribute("for", `module-${d}_`);
                    e.appendChild(f);
                    g.appendChild(e);
                    a.appendChild(g)
                }
        ...
        saveSettings() {
            ...
            localStorage.setItem(GPModulesManager_.STORAGE_NAME, JSON.stringify(this.s))
        }
        firstRunInit() {
            let a = JSON.parse(localStorage.getItem("gp_first-run"));
            !1 !== a && (a = !a,
            localStorage.setItem("gp_first-run", JSON.stringify(a)));
            this.firstRun = a
        }
        isFirstRun() {
    ...
    ;class GPSettingsImporterExporter_ extends EventTarget {
        static CATEGORIES = {
            "internal settings": ["gp_update", "gp_first-run", "gp_localization", "avatar", "gp_about"],
            key: ["gp_activation"],
        ...
        static IGNORED_STORAGES = ["gp_auth-filename"];
            ...
            window.indexedDB.databases().then(b=>{
                b = b.filter(c=>GPSettingsImporterExporter_.STATIC_DATABASES.includes(c.name)).map(c=>{
                    ...
                    return new Promise(e=>{
                        d.onsuccess = g=>{
                            const f = g.target.result;
                            g = this.filterDBStores(f).map(h=>new Promise(k=>{
                                const l = f.transaction(h, "readonly").objectStore(h);
                                l.getAll().onsuccess = m=>{
                                    k({
                                        ...
                                        indexes: [...l.indexNames].map(n=>{
                                            const {name: p, keyPath: r, unique: q, multiEntry: t} = l.index(n);
                                            return {
                                                name: p,
                                                keyPath: r,
                                                unique: q,
        ...
        filterStorage(a) {
            switch (a) {
            case "gp_mm":
                return a = JSON.parse(localStorage.getItem(a) || null),
                !!a && !(1 === Object.keys(a).length && a.disabledList && !a.disabledList.length);
        ...
        filterDBStores(a) {
            ...
            case "gp_background_db":
                if (1 < b.length && b.indexOf("backgrounds_v3"))
                    return a = b.indexOf("backgrounds"),
                    ~a && b.splice(a, 1),
                    b;
            default:
                return b
        ...
        serializeSettings(a, b) {
            return new Promise(c=>{
                const d = [];
                b = b.filter(e=>e.stores.every(g=>{
                    g.entries.forEach(f=>{
                        f.blob && d.push(this.convertBlobToBase64(f.blob, f))
                    }
                    );
        ...
        deserializeSettings(a) {
            return new Promise(async b=>{
                const {storages: c, databases: d, meta: e} = await GPUtils_.decompressFile(a)
                  , g = [];
                d.forEach(f=>{
                    f.stores.forEach(h=>{
                        h.entries.forEach(k=>{
                            k.blob && g.push(this.convertBase64ToBlob(k.blob, k))
                        }
                        )
                    }
                    )
        ...
        applySettings(a, b) {
            a && a.forEach(([c,d])=>{
                ("gp_update" !== c || this.shouldUpdateStorageBeImported()) && localStorage.setItem(c, d)
            }
            );
            b && (a = b.map(c=>new Promise((d,e)=>{
                const g = window.indexedDB.open(c.name, c.version)
                  , f = c.stores;
                g.onupgradeneeded = h=>{
                ...
                g.onsuccess = h=>{
                    const k = h.target.result;
                    h = f.map(l=>new Promise(m=>{
                        const n = k.transaction(l.name, "readwrite");
                        n.oncomplete = m;
                        const p = n.objectStore(l.name);
                        p.clear().onsuccess = ()=>{
                            l.entries.forEach((r,q)=>{
                                p.add(r, l.keyPath ? void 0 : q)
                            }
                            )
                        }
                    }
        ...
        openImporter(a, b, c) {
            ...
            this.importBtn.onclick = ()=>{
                var e = new Set([...this.categories.elements].filter(g=>g.checked).map(g=>g.name));
                e = this.filterImporterSettings(a, b, d, e);
                this.applySettings(...e)
            }
        }
        filterImporterSettings(a, b, c, d) {
            const e = new Set([...c].filter(([g])=>d.has(g)).map(([,g])=>g).flat());
            return [a.filter(g=>e.has(g[0])), b.filter(g=>e.has(g.name))]
        }
        getImportedSettingsMap(a, b) {
            ...
            [a, b].forEach(d=>{
                d.forEach(e=>{
                    const g = this.categoryMap.get(e) ?? GPSettingsImporterExporter_.UNSPECIFIED_CATEGORY
                      , f = c.get(g);
                    f ? f.push(e) : c.set(g, [e])
                }
                )
            }
            );
        ...
        renderImporterSettings(a, b) {
            ...
            Array.from(a.keys()).sort((d,e)=>this.sortingMap.get(d) - this.sortingMap.get(e)).forEach((d,e)=>{
                const g = !(d in GPSettingsImporterExporter_.CATEGORIES)
                  , f = "internal settings" === d;
                var h = g ? d : this.l[`IMPORTER_${d.toUpperCase().replace(/\s/g, "_")}`];
                const k = document.createElement("div");
                k.className = "category_";
                k.classList.toggle("disabled_", f);
                k.classList.toggle("module_", g);
                k.dataset.name = d;
                const l = document.createElement("div");
                l.className = "name_";
                l.textContent = h;
                l.addEventListener("click", n=>{
                    f || (n.ctrlKey ? this.single\u0421ontrolClickHandler(n, m) : m.click())
                }
                );
                l.addEventListener("auxclick", n=>{
                    f || 2 === n.button && this.single\u0421ontrolClickHandler(n, m)
                }
                );
                k.appendChild(l);
                e = `gp-imp-cat-${e}_`;
                ...
                h.appendChild(d);
                g ? c.appendChild(k) : this.categories.appendChild(k)
            }
            );
            c.childElementCount && (a = document.createElement("div"),
    ...
    class GPSettingsManager_ extends EventTarget {
        constructor(a, b) {
            ...
            this.addEventListener("update", ({detail: {source: c, storage: d, settings: e, changedSettings: g}})=>{
                c.dispatchEvent(new CustomEvent("settings_updated",{
                    detail: {
                        settings: g
                    }
                }));
                this.saveSettings(d, Object.assign({}, e, g))
            }
            )
        }
        setSettings(a, b) {
            const {name: c, MODULE: {title: d, settings: {storage: e, defaultSettings: g, ui: f={}}}} = a.constructor;
            b && a.addEventListener("settings_updated", b.bind(a));
            b = Object.assign({}, g, JSON.parse(localStorage.getItem(e)) || {});
            a.settings = b;
            const h = [...Object.values(f)].some(l=>!l.hidden)
              , k = this.copy(b);
            ...
            return this.buildSettingsAPI(c, b, f, e, a)
        }
        hasSettings(a) {
        ...
        buildSettingsAPI(a, b, c, d, e) {
            ...
            return new Proxy(b,{
                set(f, h, k) {
                    ...
                    Object.assign(f, k);
                    h = !(!c[h] || !0 === c[h].hidden);
                    g.dispatchEvent(new CustomEvent("update",{
                        detail: {
                            source: e,
                            storage: d,
                            settings: f,
                    ...
                    h && g.isRendered && a === g.modulesMenu.value && g.renderSettings(a, g.modulesMenu.value === a ? g.lastScrollPos : 0);
                    return !0
                },
                get(f, h) {
                    return f[h]
        ...
        render(a) {
            ...
            this.settingsView.className = "gp-settings_";
            this.settingsView.addEventListener("animationend", c=>{
                "gp-set-highlight_" === c.animationName && c.target.classList.remove("highlight_")
            }
            );
            ...
            this.modulesMenu.addEventListener("change", c=>{
                this.renderSettings(c.target.value)
            }
            );
            ...
            this.labelsBtn.addEventListener("pointerdown", c=>{
                ...
                this.container.classList.contains("labels_") && (this.labelList.value = "",
            ...
            b.addEventListener("pointerdown", c=>{
                ...
                , 1) : this.searchField.value && (this.searchField.value = "",
                this.filter(null))
            }
            );
            a.appendChild(b);
            ...
            this.searchField.addEventListener("focus", c=>{
                c.target.select();
                document.dispatchEvent(new CustomEvent("_keys_lock",{
                    detail: {
                        state: !0
                ...
                document.addEventListener("pointerdown", this.searchBlurHandler, !0)
            }
            );
            this.searchField.addEventListener("blur", c=>{
        ...
        renderSettings(a, b=0) {
            if (a && this.viewsData.has(a) && !this.isHiddenModule(a)) {
                this.currentLabels.clear();
                var {source: c, storage: d, settings: e, ui: g} = this.viewsData.get(a);
                this.settingsView.innerHTML = "";
                this.settingsView.classList.remove("json-data_");
                var f = document.createElement("div");
                f.className = "controls_ gp-ui-scrollbar_";
                f.addEventListener("scroll", p=>{
                    this.lastScrollPos = p.target.scrollTop
                }
                );
                this.settingsView.appendChild(f);
                var h = document.createElement("div");
                h.className = "buttons_";
                this.settingsView.appendChild(h);
                var k = document.createElement("div");
                k.className = "load-btn_ btn_ gp-ui-btn_";
                k.textContent = "\ud83e\udc45";
                k.title = this.l.LOAD_JSON_TTL;
                k.addEventListener("click", ()=>{
                    this.settingsView.classList.toggle("json-data_");
                    l.focus()
                }
                );
                k.addEventListener("animationend", p=>{
                    p.target.classList.remove("failure_");
                    p.target.classList.remove("success_")
                }
                );
                h.appendChild(k);
                ...
                l.addEventListener("input", p=>{
                    this.jsonDataInputHandler(a, p.target, k)
                }
                );
                l.addEventListener("focus", p=>{
                    document.dispatchEvent(new CustomEvent("_keys_lock",{
                        detail: {
                            state: !0
                        }
                ...
                for (let p in g)
                    ...
                    this.isLabel(p)) {
                        ...
                        h.appendChild(n);
                        this.currentLabels.set(m.text, n)
                    } else if (this.isSeparator(p))
                        ...
                        default:
                            ...
                            n.appendChild(q);
                            m = this.buildName(p, m.description);
                            n.appendChild(m);
                            m = this.buildControl(g, p, e[p], c, d, e);
                            n.appendChild(m);
                            h.appendChild(n)
                        }
                f.appendChild(h);
                f.scrollHeight > f.clientHeight && (this.settingsView.clientHeight - 41 > f.scrollHeight ? f.style.paddingBottom = `${f.scrollHeight - f.clientHeight}px` : f.classList.add("scrollbar_"));
                this.labelsBtn.classList.toggle("empty_", !this.currentLabels.size);
                this.updateLabelList();
                this.searchField.value = "";
                this.container.classList.remove("search_");
                this.lastScrollPos = f.scrollTop = b;
        ...
        buildTooltip(a) {
            ...
            b.textContent = "?";
            if (!a)
                return b.classList.add("disabled_"),
                b;
            b.addEventListener("pointerenter", c=>{
                ...
                d.textContent = a;
                const {x: e, y: g, width: f, height: h} = c.target.getBoundingClientRect();
                ({height: c} = d.getBoundingClientRect());
                d.style.cssText = `top: ${g - (c - h) / 2}px; left: ${e + f + 12}px`;
                window.gpSettingsTooltip = d
            }
            );
        ...
        buildControl(a, b, c, d, e, g) {
            const {type: f, args: h, formatter: k, inputTrigger: l} = a[b];
            a = document.createElement("div");
            ...
            case "switch":
                ...
                n.setAttribute("for", `ctrl-${b}_`);
                m.appendChild(n);
                a.appendChild(m);
                break;
            case "slider":
                const {min: p, max: r, step: q, reverse: t} = h;
                m = document.createElement("input");
                m.className = "gp-ui-slider_";
                m.type = "range";
                m.min = p;
                m.max = r;
                m.step = q;
                m.value = c;
                m.name = b;
                t && (m.style.direction = "rtl");
                m.addEventListener("input", w=>{
                    B.textContent = k ? k(Number.parseFloat(w.target.value)) : w.target.value
                }
                );
                const B = document.createElement("div");
                B.className = "gp-ui-slider-preview_";
                B.textContent = k ? k(c) : c;
                a.appendChild(m);
                a.appendChild(B);
                break;
            case "input":
                n = h?.secure;
                m = document.createElement("input");
                m.className = "gp-ui-input_";
                m.classList.toggle("secure-input_", !!n);
                m.spellcheck = !1;
                m.autocomplete = "off";
                m.value = c;
                m.name = b;
                m.addEventListener("keydown", w=>{
                    switch (w.key) {
                    case "Escape":
                        w.target.value = w.target.dataset.initialValue;
                    case "Enter":
                        w.target.blur()
                    }
                }
                );
                m.addEventListener("focus", w=>{
                    w.target.select();
                    document.dispatchEvent(new CustomEvent("_keys_lock",{
                        detail: {
                            state: !0
                    ...
                    w.target.dataset.initialValue = w.target.value
                }
                );
            ...
            case "dropdown":
                ...
                m.className = "gp-ui-dropdown_";
                m.autocomplete = "off";
                m.name = b;
                const {items: A, itemsProxySetting: u} = h;
                (u && g[u] || (A?.length ? A : [c])).forEach((w,z)=>{
                    const x = document.createElement("option");
                    x.value = w;
                    x.textContent = k ? k(w, z) : w;
                    m.appendChild(x)
                }
                );
                m.value = c;
            ...
            case "list-ms":
            case "list-md":
                n = "list-ms" === f ? h.items : c;
                m = document.createElement("form");
                m.className = "gp-ui-list-m_";
                m.name = b;
                n.forEach((w,z)=>{
                    ...
                    x.value = w;
                    x.name = b;
                    x.checked = c.includes(w);
                    m.appendChild(x);
                    x = document.createElement("label");
                    x.textContent = k ? k(w, z) : w;
                    x.setAttribute("for", `ctrl-${b}-${z}_`);
                    m.appendChild(x)
                }
                );
                a.appendChild(m);
            ...
            case "list-i":
                const {icons: v} = h;
                m = document.createElement("form");
                m.className = "gp-ui-list-i_";
                m.name = b;
                const y = [];
                Object.keys(v).forEach((w,z)=>{
                    ...
                    F.className = "gp-ui-list-i-icon_";
                    F.title = w.split("-").map(K=>K[0].toUpperCase() + K.slice(1)).join(" ");
                    F.style.backgroundImage = `url("${v[w]}")`;
                    F.setAttribute("for", `ctrl-${b}-${z}_`);
                    m.appendChild(F)
                }
                );
                a.appendChild(m);
            ...
            case "color":
                m = document.createElement("input"),
                m.className = "gp-ui-color_",
                m.type = "color",
                m.value = c,
                m.name = b,
                a.appendChild(m)
            }
            m.addEventListener(l ? "input" : "change", p=>{
                p = {
                    [p.target.name]: this.parseValue(p.target, f)
                };
                this.dispatchEvent(new CustomEvent("update",{
                    detail: {
                        source: d,
                        storage: e,
                        settings: Object.assign(g, p),
                        changedSettings: p
                    }
                }))
            }
        ...
        jsonDataInputHandler(a, b, c) {
            ...
            try {
                ...
                const {settings: e, source: g, storage: f} = this.viewsData.get(a);
                d = this.filterSettings(d, e);
                if (Object.keys(d).length) {
                    const h = this.copy(d);
                    Object.assign(e, h);
                    this.renderSettings(a);
                    this.dispatchEvent(new CustomEvent("update",{
                        detail: {
                            source: g,
                            storage: f,
        ...
        selectLabel(a) {
            if (a = this.currentLabels.get(a))
                a.classList.add("highlight_"),
                a.scrollIntoView({
                    behavior: "smooth"
                })
        }
        updateLabelList() {
            ...
            this.currentLabels.forEach((b,c)=>{
            ...
            this.labelList.appendChild(a);
            this.labelList.size = this.currentLabels.size + 1;
            this.labelList.style.height = `${26 * this.currentLabels.size}px`;
            this.container.classList.remove("labels_")
        }
        filter(a) {
            a = a?.replace(/\s/g, "").toLowerCase();
            Array.from(this.settingsView.firstElementChild.children).forEach(b=>{
                if (a) {
        ...
        searchBlurHandler(a) {
            a.target !== this.searchField && (this.searchField.blur(),
            document.removeEventListener("pointerdown", this.searchBlurHandler, !0))
        }
        ...
        reset(a) {
            const {settings: b, defaultSettings: c, source: d, storage: e} = this.viewsData.get(a)
              , g = this.copy(c);
            Object.assign(b, g);
            for (let f in b)
                f in g || delete b[f];
        ...
        restore(a) {
            const {settings: b, initialSettings: c, source: d, storage: e} = this.viewsData.get(a)
              , g = this.copy(c);
            Object.assign(b, g);
            this.renderSettings(a);
            this.dispatchEvent(new CustomEvent("update",{
        ...
        toggle(a, b, c=!1) {
            this.isRendered ? (this.container.classList.toggle("hidden", void 0 === a ? a : !a),
            this.settingsView.classList.remove("json-data_"),
            a && b && this.renderSettings(b),
            this.container.classList.toggle("load-btn-shown_", !!c)) : !1 !== a && (this.render(b),
    ...
    class GPAcoDecoder_ {
        ...
        static parseACO(a) {
            ...
            const b = a.getUint16(2)
              ...
              , d = [];
            for (let e = 0; e < b; e++) {
                const [g,f,h] = this.readData(a, 6 + 10 * e, c);
                let k;
                switch (c) {
                ...
                case this.COLOR_MODE.HSB:
                    k = {
                        h: Math.trunc(g / 182.04),
                        s: Math.trunc(f / 655.35),
                ...
                case this.COLOR_MODE.GRAYSCALE:
                    k = {
                        r: Math.trunc(g / 39.0625),
                        g: Math.trunc(g / 39.0625),
                        b: Math.trunc(g / 39.0625),
                        a: 1
                    }
                }
                k && d.push(k)
        ...
        static readData(a, b, c) {
            ...
            for (let g = 0; 4 > g; g++) {
                var e = b + 2 * g;
                e = ~this.COLOR_MODES_SIGNS[c][g] ? a.getUint16(e) : a.getInt16(e);
                d.push(e)
            }
            return d
        }
    ...
    ;class GPColorPicker_ extends EventTarget {
        ...
        constructor(a=GPColorPicker_.DEFAULT_WIDTH, b=GPColorPicker_.DEFAULT_HEIGHT, c=GPColorPicker_.DEFAULT_HUE_POSITION) {
            ...
            this.hueBarSize = this.width - 2 * GPColorPicker_.HUE_MARGIN;
            this.huePosition = c;
            this.huePosDir = c === GPColorPicker_.TOP || c === GPColorPicker_.BOTTOM ? GPColorPicker_.HORIZONTAL : GPColorPicker_.VERTICAL;
            this.huePosDir === GPColorPicker_.HORIZONTAL ? (this.hueWidth = this.width,
            this.hueHeight = GPColorPicker_.HUE_MIN_SIDE_SIZE,
            this.paletteWidth = this.width,
            this.paletteHeight = this.height - this.hueHeight) : (this.hueWidth = GPColorPicker_.HUE_MIN_SIDE_SIZE,
        ...
        show(a, b) {
            ...
            this.container.style.top = `${b - this.palettePointerY - d}px`;
            this.container.style.left = `${a - this.palettePointerX - c}px`;
        ...
        render(a, b) {
            ...
            a = this.container.querySelector(".gp-color-picker_ > .hue");
        ...
        paletteDownHandler(a) {
            ...
            this.palette.addEventListener("pointerup", b=>{
        ...
        hueSliderDownHandler(a) {
            ...
            this.hueSlider.addEventListener("pointermove", this.hueSliderMoveHandler);
            this.hueSlider.addEventListener("pointerup", b=>{
        ...
        getCoords(a) {
            const b = a.target.getBoundingClientRect()
              ...
              , [e,g] = [c - b.left, d - b.top];
            return [a.target.clientWidth / b.width * e, a.target.clientHeight / b.height * g]
        }
        getColor() {
        ...
        setColor(a) {
            ...
            const e = this.paletteWidth * c
              , g = this.paletteHeight - this.paletteHeight * d;
            this.palettePointerX = Math.max(0, Math.min(this.paletteWidth, e));
            this.palettePointerY = Math.max(0, Math.min(this.paletteHeight, g));
            this.updateHueSlider(a);
            this.updatePaletteHue(b);
            this.updatePalettePointer(e, g)
        }
    }
    ...
    class GPColorUtils_ {
        static hsvToRgb(a, b, c) {
            ...
            return [Math.round(255 * d), Math.round(255 * e), Math.round(255 * g)]
        }
    ...
    class GPPainter_ extends EventTarget {
        ...
        static DEFAULT_MIN_THICKNESS = 2;
        static DEFAULT_MAX_THICKNESS = 300;
        static DEFAULT_MINIMUM_OPACITY = .02;
        static DEFAULT_OPACITY_SENSITIVITY = 1;
        static DEFAULT_BRIGHTNESS_SENSITIVITY = 1;
        static DEFAULT_MIN_ZOOM = 1;
        static DEFAULT_MAX_ZOOM = 30;
        static DEFAULT_ZOOM_SENSITIVITY = 10;
        static DEFAULT_LINE_SMOOTHING_LEVEL = 0;
        static STABILIZER_SIZE = 5;
        static DEFAULT_CENTERING_CIRCLE_TOOL = !1;
        static POINTER_COLOR = this.DEFAULT_COLOR;
        ...
        static FIXED_SCREEN_SIZE = !1;
        static READY_CONFIRMATION = !1;
        ...
        static DEFAULT_PANELS_BACKGROUND_COLOR = "#5e1933";
        static DEFAULT_PANELS_BACKGROUND_OPACITY = 50;
        static DEFAULT_PANELS_ELEMENTS_COLOR = "#ff8eaf";
        static DEFAULT_PANELS_ELEMENTS_OPACITY = 60;
        static HEADER_INSTRUCTIONS_COLOR = "#43de99";
        static HIDE_HEADER_BACKGROUND = !1;
        static AUTO_HIDE_HEADER_ELEMENTS = !1;
        static AUTO_HIDE_HEADER_ELEMENTS_DELAY = .3;
        ...
        static DEFAULT_SYMMETRY_GUIDES_COLOR = "#4affff";
        static DEFAULT_SYMMETRY_GUIDES_OPACITY = 1;
        static DEFAULT_SYMMETRY_GUIDES_WIDTH = 1;
        static DEFAULT_SYMMETRY_MODE = this.SYMMETRY_MODES.VERTICAL;
        static SYMMETRY_GUIDES_COUNT_SENSITIVITY = Math.round(window.screen.height / 1080 * 5);
        static DEFAULT_SYMMETRY_RADIAL_GUIDES_COUNT = 8;
        static DEFAULT_SYMMETRY_MANDALA_GUIDES_COUNT = 4;
        ...
        static UI_SETTINGS = {
            ...
            minThickness: {
                value: this.DEFAULT_MIN_THICKNESS,
                type: "slider",
                args: [1, 600, 1],
                description: "\u041c\u0438\u043d\u0438\u043c\u0430\u043b\u044c\u043d\u0430\u044f \u0442\u043e\u043b\u0449\u0438\u043d\u0430 \u043a\u0438\u0441\u0442\u0438, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u0430\u044f \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c"
            },
            maxThickness: {
                value: this.DEFAULT_MAX_THICKNESS,
                type: "slider",
                args: [1, 600, 1],
            ...
            minOpacity: {
                value: this.DEFAULT_MINIMUM_OPACITY,
                type: "slider",
                args: [.01, 1, .01],
                description: "\u041c\u0438\u043d\u0438\u043c\u0430\u043b\u044c\u043d\u0430\u044f \u043d\u0430\u0441\u044b\u0449\u0435\u043d\u043d\u043e\u0441\u0442\u044c \u043a\u0438\u0441\u0442\u0438, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u0430\u044f \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c"
            },
            opacitySensitivity: {
                value: this.DEFAULT_OPACITY_SENSITIVITY,
                type: "slider",
                args: [.1, 3, .1],
            ...
            brightnessSensitivity: {
                value: this.DEFAULT_BRIGHTNESS_SENSITIVITY,
                type: "slider",
                args: [.1, 3, .1],
            ...
            pointerOpacity: {
                value: this.POINTER_OPACITY,
                type: "slider",
                args: [0, 1, .1],
                description: "\u041f\u0440\u043e\u0437\u0440\u0430\u0447\u043d\u043e\u0441\u044c \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u044f"
            },
            pointerOutlineOpacity: {
                value: this.POINTER_OUTLINE_OPACITY,
                type: "slider",
                args: [0, 1, .1],
            ...
            colorPickerHuePosition: {
                value: this.COLOR_PICKER_HUE_POSITION,
                type: "dropdown",
                args: [GPColorPicker_.TOP, GPColorPicker_.BOTTOM, GPColorPicker_.RIGHT, GPColorPicker_.LEFT],
            ...
            panelsBackgroundColor: {
                value: this.DEFAULT_PANELS_BACKGROUND_COLOR,
                type: "color",
                inputTrigger: !0,
                description: "\u0426\u0432\u0435\u0442 \u0444\u043e\u043d\u0430 \u043f\u0430\u043d\u0435\u043b\u0435\u0439 \u0438\u043d\u0442\u0435\u0440\u0444\u0435\u0439\u0441\u0430"
            },
            panelsBackgroundOpacity: {
                value: this.DEFAULT_PANELS_BACKGROUND_OPACITY,
                type: "slider",
                args: [0, 100, 1],
                inputTrigger: !0,
            ...
            panelsElementsColor: {
                value: this.DEFAULT_PANELS_ELEMENTS_COLOR,
                type: "color",
                inputTrigger: !0,
                description: "\u0426\u0432\u0435\u0442 \u044d\u043b\u0435\u043c\u0435\u043d\u0442\u043e\u0432 \u043f\u0430\u043d\u0435\u043b\u0435\u0439 \u0438\u043d\u0442\u0435\u0440\u0444\u0435\u0439\u0441\u0430"
            },
            panelsElementsOpacity: {
                value: this.DEFAULT_PANELS_ELEMENTS_OPACITY,
                type: "slider",
                args: [0, 100, 1],
                inputTrigger: !0,
            ...
            lineSmoothingLevel: {
                value: this.DEFAULT_LINE_SMOOTHING_LEVEL,
                type: "slider",
                args: [0, 8, 1],
            ...
            symmetryGuidesColor: {
                value: this.DEFAULT_SYMMETRY_GUIDES_COLOR,
                type: "color",
                inputTrigger: !0,
                description: "\u0426\u0432\u0435\u0442 \u043d\u0430\u043f\u0440\u0430\u0432\u043b\u044f\u044e\u0449\u0438\u0445 \u0441\u0438\u043c\u043c\u0435\u0442\u0440\u0438\u0438"
            },
            symmetryGuidesOpacity: {
                value: this.DEFAULT_SYMMETRY_GUIDES_OPACITY,
                type: "slider",
                args: [0, 1, .01],
                inputTrigger: !0,
            ...
            symmetryGuidesWidth: {
                value: this.DEFAULT_SYMMETRY_GUIDES_WIDTH,
                type: "slider",
                args: [1, 8, .5],
                inputTrigger: !0,
            ...
            symmetryRadialGuidesCount: {
                value: this.DEFAULT_SYMMETRY_RADIAL_GUIDES_COUNT,
                hidden: !0
            },
            symmetryMandalaGuidesCount: {
                value: this.DEFAULT_SYMMETRY_MANDALA_GUIDES_COUNT,
                hidden: !0
            },
            symmetryMode: {
                value: this.DEFAULT_SYMMETRY_MODE,
                hidden: !0
            },
            _12: {
                text: "Tools"
            ...
            centeringCircleTool: {
                value: this.DEFAULT_CENTERING_CIRCLE_TOOL,
                type: "switch",
        ...
        static INIT(a, b) {
            new GPPainter_(a.gpproxy,a.timer,a.reference,a.ac,a.abt,b)
        }
        constructor(a, b, c, d, e, g) {
            super();
            this.gpproxy = a;
            ...
            this.abt = e;
            this.l = g;
            this.s = this.buildSettingsAPI(Object.assign({}, this.parseUISettings(GPPainter_.UI_SETTINGS), JSON.parse(localStorage.getItem("gp_painter"))));
            this.bindings = Object.assign({}, JSON.parse(JSON.stringify(GPPainter_.DEFAULT_BINDINGS)), JSON.parse(localStorage.getItem("gp_painter_bindings")));
            this.bindingsLabels = {
            ...
            this.isDrawing = this.isToolCentering = this.isZoomedToPoint = this.isHand = this.isEraser = this.isMirrored = this.isZooming = this.isBrightnessSetting = this.isThicknessSetting = this.isOpacitySetting = this.isDropperDown = this.isDropper = !1;
            ...
            this.globalCoordsHandler = this.globalCoordsHandler.bind(this);
            this.keyDownHandler = this.keyDownHandler.bind(this);
            this.keyUpHandler = this.keyUpHandler.bind(this);
            this.inject = this.inject.bind(this);
            this.searchDrawContainer = this.searchDrawContainer.bind(this);
            this.getFillData = this.getFillData.bind(this);
            this.saveImage = this.saveImage.bind(this);
            this.clearPointer = this.clearPointer.bind(this);
            this.middleButtonDown = this.middleButtonDown.bind(this);
            this.rightButtonDown = this.rightButtonDown.bind(this);
            this.strokeDown = this.strokeDown.bind(this);
            this.strokeUp = this.strokeUp.bind(this);
            this.strokeMove = this.strokeMove.bind(this);
            this.strokeProcess = this.strokeProcess.bind(this);
            this.drawPointer = this.drawPointer.bind(this);
            this.dropperKeyDown = this.dropperKeyDown.bind(this);
            this.dropperKeyUp = this.dropperKeyUp.bind(this);
            this.dropperMove = this.dropperMove.bind(this);
            this.dropperDown = this.dropperDown.bind(this);
            this.dropperUp = this.dropperUp.bind(this);
            this.resetKeys = this.resetKeys.bind(this);
            this.thicknessKeyDown = this.thicknessKeyDown.bind(this);
            this.thicknessKeyUp = this.thicknessKeyUp.bind(this);
            this.thicknessDown = this.thicknessDown.bind(this);
            this.opacityKeyDown = this.opacityKeyDown.bind(this);
            this.opacityKeyUp = this.opacityKeyUp.bind(this);
            this.opacityDown = this.opacityDown.bind(this);
            this.brightnessKeyDown = this.brightnessKeyDown.bind(this);
            this.brightnessKeyUp = this.brightnessKeyUp.bind(this);
            ...
            this.handKeyUp = this.handKeyUp.bind(this);
            this.handDown = this.handDown.bind(this);
            this.symmetryGuidesDownHandler = this.symmetryGuidesDownHandler.bind(this);
            this.changeSymmetryRadialGuidesCount = this.changeSymmetryRadialGuidesCount.bind(this);
            this.changeSymmetryMandalaGuidesCount = this.changeSymmetryMandalaGuidesCount.bind(this);
            this.blockContextMenu = this.blockContextMenu.bind(this);
            this.resizeWindowHandler = this.resizeWindowHandler.bind(this);
            this.windowsInkCheck = this.windowsInkCheck.bind(this);
            this.keysMap = this.buildKeysMap(this.bindings);
            this.pressedKeys = new Set;
            this.currentBinding = null;
            this.addEventListener("stroke", ({detail: {data: h, symmetryStrokesData: k=[]}})=>{
                this.drawFunction(this.canvasCtx, [h, ...k]);
                this.strokeOptions = [];
                this.strokeCoords = [];
                this.symmetryCoords = [];
                k.length && (this.symmetryStrokesGroups[h[1]] = h[1],
                k.map(l=>{
                    this.symmetryStrokesGroups[l[1]] = h[1]
                }
                ));
                this.clearStroke();
                this.history.push(h, ...k);
                this.undos.length && (this.undos = []);
                this.shouldBeSigned() && this.sign()
            }
            );
            this.addEventListener("stroke_started", ({detail: {data: h, symmetryStrokesData: k=[]}})=>{
                const l = !!k.length
                  , m = h[0];
                this.gpproxy.getSendQueueSize() && this.isToolInTime(m) || (this.gpproxy.tool(1, h, l),
                k.forEach(n=>{
                    this.gpproxy.tool(1, n, l)
                }
                ))
            }
            );
            this.addEventListener("stroke_process", ({detail: {data: h, symmetryStrokesData: k=[]}})=>{
                const l = !!k.length;
                this.gpproxy.tool(3, h, l);
                k.forEach(m=>{
                    this.gpproxy.tool(3, m, l)
                }
                )
            }
            );
            this.addEventListener("stroke_ended", ({detail: {data: h, symmetryStrokesData: k=[]}})=>{
                const l = !!k.length
                  , m = l || this.gpproxy.getSendQueueSize() && this.isToolInTime(h[0]) ? 1 : 3;
                this.gpproxy.tool(m, h, l);
                k.forEach(n=>{
                    this.gpproxy.tool(m, n, l)
                }
                )
            }
            );
            this.addEventListener("stroke_undo", ({detail: {data: h, symmetryStrokesData: k=[]}})=>{
                const l = !!k.length;
                this.gpproxy.undo(h[1], l);
                k.forEach(m=>{
                    this.gpproxy.undo(m[1], l)
                }
                )
            }
            );
            this.addEventListener("stroke_redo", ({detail: {data: h, symmetryStrokesData: k=[]}})=>{
                const l = !!k.length;
                this.gpproxy.redo(h, l);
                k.forEach(m=>{
                    this.gpproxy.redo(m, l)
                }
                )
            }
            );
            this.addEventListener("settings_updated", ({detail: {settings: h}})=>{
                this.updateSettings(h);
                this.saveSettings()
            }
            );
            this.gpproxy.addEventListener("localization", ({detail: {data: h, type: k}})=>{
                "draw" === k && (this.localization = h)
            }
            );
            ...
            this.gpproxy.addEventListener("turns_ended", h=>{
                this.terminate();
                this.stopTimer()
            }
            );
            this.gpproxy.addEventListener("send_queue_updated", ({detail: {size: h}})=>{
                this.iface.updateActionQueueSize(h)
            }
            );
            this.iface.addEventListener("settings_updated", ({detail: {settings: h}})=>{
                Object.assign(this.s, h);
                this.updateSettings(h);
                this.saveSettings()
            }
            );
            this.iface.addEventListener("bindings_updated", ({detail: {bindings: h}})=>{
                this.updateBindings(h);
                this.saveBindings()
            }
            );
            document.addEventListener("_url_changed", ({detail: {path: h}})=>{
                "/draw" === h && (this.enabled = this.isPermittedMode(),
                this.terminate(),
                this.inject())
            }
            );
            this.gpproxy.addEventListener("rejoin", ({detail: {screen: h}})=>{
                h === GPProxy_.SCREEN.PAINTER && (this.enabled = this.isPermittedMode(),
                this.terminate(),
                this.inject())
            }
            );
            document.addEventListener("_keys_lock", ({detail: {state: h}})=>{
                this.setKeysLockState(h)
            }
            );
            document.addEventListener("_subs_status", ({detail: {status: h}})=>{
                this.isSubscribed = 1
            }
            );
            Document.prototype.addEventListener = new Proxy(Element.prototype.addEventListener,{
                apply(h, k, l) {
                    if ("keydown" !== l[0] || !1 !== l[2])
                        return h.apply(k, l)
                }
            });
            const f = this;
            Element.prototype.addEventListener = new Proxy(Element.prototype.addEventListener,{
                apply(h, k, l) {
                    if (!(k.classList?.contains("drawingContainer") && ["mousedown", "pointerdown", "contextmenu", "touchstart"].includes(l[0]) && f.isPermittedMode()))
                        return h.apply(k, l)
                }
            });
            this.timer && this.timer.addEventListener("finish", h=>{
            ...
            this.reference && this.reference.addEventListener("state_changed", ({detail: {isEnabled: h}})=>{
                h && this.resizeWindowHandler()
            }
            )
        }
        buildKeysMap(a) {
        ...
        bindingHandler(a, b) {
            ...
            c ? (a.preventDefault(),
            a.stopPropagation(),
            a.repeat && a.repeat !== !!c.repeat || !a.repeat && c.name === this.currentBinding?.name || (c.handler.apply(this, [a]),
            this.currentBinding = c)) : !b && this.isNativeBinding(a.code) && a.stopPropagation()
        }
        isNativeBinding(a) {
        ...
        getBinding() {
            ...
            if (this.currentBinding) {
                ...
                if (!this.keysMap[a])
                    return this.currentBinding.keys.length > a && (this.currentBinding = null),
                    null
            }
        ...
        keyDownHandler(a) {
            this.isDisabled || this.areKeysLocked || (this.pressedKeys.add(a.code),
            this.bindingHandler(a))
        }
        keyUpHandler(a) {
            this.isDisabled || this.areKeysLocked || (this.pressedKeys.delete(a.code),
            this.bindingHandler(a, !0))
        }
        render() {
            this.container = document.createElement("div");
            ...
            this.symmetryGuides.addEventListener("pointerdown", this.symmetryGuidesDownHandler);
        ...
        terminate() {
            !this.isTerminated && this.container && (clearTimeout(this.strokeTimer),
            clearTimeout(this.searchTimer),
            window.removeEventListener("blur", this.resetKeys),
            window.removeEventListener("focus", this.resetKeys),
            window.removeEventListener("resize", this.resizeWindowHandler),
            document.removeEventListener("pointermove", this.globalCoordsHandler, !0),
        ...
        init() {
            ...
            this.undos = [];
            this.pointerY = this.pointerX = 0;
            this.isDrawing = this.isToolCentering = this.isZoomedToPoint = this.isHand = this.isEraser = this.isMirrored = this.isZooming = this.isBrightnessSetting = this.isThicknessSetting = this.isOpacitySetting = this.isDropperDown = this.isDropper = this.areKeysLocked = !1;
            this.currentBinding = null;
            this.pressedKeys.clear();
            this.isSymmetryGuidesMoved = this.isSymmetryGuidesEditable = this.isReadyWarningShown = this.isNote = this.isDisabled = !1;
            this.symmetryStrokesOptions = [];
            this.symmetryCoords = [];
            !this.isSubscribed && !this.gpproxy.isSoloGame() && 1 < this.s.symmetryMode && (this.s.symmetryMode = GPPainter_.DEFAULT_SYMMETRY_MODE,
            this.drawSymmetryGuides());
        ...
        inject() {
            this.enabled && (this.container || this.render(),
        ...
        searchDrawContainer() {
            return new Promise(a=>{
                this.searchTimer = setTimeout(()=>{
                    ...
                    b ? (clearTimeout(this.searchTimer),
                    a(b)) : this.searchDrawContainer()
                }
        ...
        initColorPicker({width: a, height: b, huePos: c}={}) {
            ...
            this.colorPicker.addEventListener("color", ({detail: {color: d}})=>{
                this.color = d;
                this.iface.updateColorInput(d);
                this.iface.updateColorPicker(d);
                this.iface.resetPaletteColor()
            }
            );
        ...
        middleButtonDown(a) {
            1 !== a.button || this.isThicknessSetting || this.isOpacitySetting || this.isBrightnessSetting || this.isZooming || this.isHand || (this.handDown(a, !0),
            a.stopPropagation(),
        ...
        rightButtonDown(a) {
            if (2 === a.button) {
                if (this.isThicknessSetting)
                    ...
                    this.isZooming ? (this.stroke.removeEventListener("pointermove", this.zoomMoveHandler),
                    this.resetZoom()) : this.isHand ? this.resetZoom() : this.strokeDown(a, this.color2);
        ...
        strokeDown(a, b) {
            ...
            if (!(this.isDropper || this.isDropperDown || this.isOpacitySetting || this.isThicknessSetting || this.isBrightnessSetting || this.isZooming || this.isHand)) {
                ...
                this.isSymmetryEnabled && this.convertToSymmetryCoords(c).forEach((d,e)=>{
                    ...
                    g[1] = this.strokeId++;
                    this.symmetryStrokesOptions[e] = g;
                    this.symmetryCoords[e] = [d];
                    this.centering\u0421oords[e + 1] = d.slice()
                }
                );
                this.lineSmoothingCounter = 1;
                this.tool === GPPainter_.TOOL.FILL ? (this.updateStrokeCoords(this.strokeCoords, this.getCoords(a)),
                ...
                !this.isSymmetryEnabled && this.isToolInTime(this.tool) && (this.strokeTimer = setTimeout(this.strokeProcess, 1E3),
                this.dispatchEvent(new CustomEvent("stroke_started",{
                    detail: {
                        data: a,
        ...
        rotatePoint(a, b, c, d, e) {
            ...
            e = Math.cos(g);
            g = Math.sin(g);
            return [e * (c - a) + g * (d - b) + a, e * (d - b) - g * (c - a) + b]
        }
        convertToSymmetryCoords([a,b], c=this.s.symmetryMode) {
            ...
            case GPPainter_.SYMMETRY_MODES.RADIAL:
                ...
                var f = 360 / c;
                for (var h = 1; h < c; h++) {
                    const [l,m] = this.rotatePoint(d, e, a, b, h * f);
                    g.push([Math.round(l), Math.round(m)])
                }
                break;
            case GPPainter_.SYMMETRY_MODES.MANDALA:
                c = e + (e - b);
                f = 2 * this.s.symmetryMandalaGuidesCount;
                h = 360 / f;
                ...
                for (let l = 1; l < f; l++) {
                    ...
                    n = c) : (m = l * h,
                    n = b);
                    const [p,r] = this.rotatePoint(d, e, a, n, m);
                    g.push([Math.round(p), Math.round(r)])
                }
            }
            return g
        }
        strokeMove(a) {
            ...
            this.isSymmetryEnabled && (b = this.convertToSymmetryCoords(b),
        ...
        strokeProcess() {
            ...
            !this.isSymmetryEnabled && this.isToolInTime(this.tool) && (clearTimeout(this.strokeTimer),
        ...
        updateStrokeCoords(a, b, c=0) {
            ...
            case GPPainter_.TOOL.CIRCLE_FILLED:
                ...
                if (this.isCenteringActivated) {
                    const [e,g] = this.centering\u0421oords[c];
                    a[0][0] = e - (b[0] - e);
                    a[0][1] = g - (b[1] - g)
                }
                break;
        ...
        buildStrokeData(a, b, c=!1) {
            return [...a, ...(!c && this.isMirrored && a[0] !== GPPainter_.TOOL.FILL ? this.mirrorStrokeCoords(b) : b)]
        }
        drawPointer(a, b, c) {
        ...
        renderPointer(a, b, c, d=this.thickness, e, g) {
            this.clearPointer();
            c = this.isOpacitySetting ? this.opacity : c;
            d = this.isZooming ? 1 : !e && GPPainter_.TOOLS_THICKNESSES[this.tool] || d;
            this.tool === GPPainter_.TOOL.ERASER && this.s.doubleEraserThickness && (d *= 2);
            e = this.pointerCtx;
            e.beginPath();
            e.arc(a, b, d / 2 * this.density, 0, 2 * Math.PI);
            c && (e.fillStyle = `rgba(${this.hexToRgb(this.color).join(",")},${c}`,
            e.fill());
            ...
            if (d < GPPainter_.POINTER_CROSSHAIR_MIN_THICKNESS) {
                d = 3 * d * this.density;
                const f = GPPainter_.POINTER_CROSSHAIR_LINE_LENGTH * this.density;
                e.strokeStyle = GPPainter_.POINTER_OUTLINE_COLOR;
                e.globalAlpha = this.s.pointerOutlineOpacity;
                e.beginPath();
                e.moveTo(a, b - d);
            ...
            if (g) {
                const [f,h] = g;
                e.beginPath();
                e.arc(f, h, GPPainter_.POINTER_DOT_THICKNESS / 2 * this.density, 0, 2 * Math.PI);
                c && (e.fillStyle = `rgba(${this.hexToRgb(this.color).join(",")},${c}`,
                e.fill());
                e.strokeStyle = GPPainter_.POINTER_COLOR;
                e.stroke();
                e.beginPath();
                e.arc(f, h, (GPPainter_.POINTER_DOT_THICKNESS / 2 + 1) * this.density, 0, 2 * Math.PI);
                e.strokeStyle = GPPainter_.POINTER_OUTLINE_COLOR;
                e.globalAlpha = this.s.pointerOutlineOpacity;
                e.stroke();
                e.globalAlpha = this.s.pointerOpacity
        ...
        setColor(a, b=!1) {
            ...
            this.iface.updateColorInput(a);
            this.iface.updateColorPicker(a, b);
            this.iface.resetPaletteColor()
        }
        setColor2(a) {
            this.color2 = a;
            this.iface.updateColor2Input(a)
        }
        getColor() {
            return this.color
        }
        ...
        getCoords(a) {
            const b = a.target.getBoundingClientRect()
              , [c,d] = a.touches ? [a.touches[0].clientX, a.touches[0].clientY] : [a.clientX, a.clientY]
              , [e,g] = [c - b.left, d - b.top];
            return [Math.round(a.target.width / b.width * e), Math.round(a.target.height / b.height * g)]
        }
        getOCoords(a) {
        ...
        resetKeys(a) {
            this.container && (this.drawingArea.classList.remove("dropper_", "dropper-s_", "hand_", "hand-s_"),
            this.isToolCentering = this.isHand = this.isEraser = this.isZooming = this.isBrightnessSetting = this.isThicknessSetting = this.isOpacitySetting = this.isDropperDown = this.isDropper = !1,
            this.stroke.removeEventListener("pointermove", this.thicknessMoveHandler),
            this.stroke.removeEventListener("pointermove", this.opacityMoveHandler),
            this.stroke.removeEventListener("pointermove", this.brightnessMoveHandler),
            this.stroke.removeEventListener("pointermove", this.zoomMoveHandler),
        ...
        dropperKeyUp(a) {
            this.isDropper && (a.preventDefault(),
            this.isDropper = !1,
            this.drawingArea.classList.remove("dropper_"),
            this.isDropperDown || this.stroke.removeEventListener("pointermove", this.dropperMove))
        }
        dropperDown(a) {
            this.isDropper && (this.isDropperDown = !0,
            this.dropperMove(a),
            this.drawingArea.classList.add("dropper-s_"),
            this.stroke.setPointerCapture(a.pointerId),
            this.stroke.addEventListener("pointermove", this.dropperMove),
            this.stroke.addEventListener("pointerup", this.dropperUp, {
                once: !0
            }))
        }
        dropperMove(a) {
        ...
        getPixelColor(a, b) {
            ...
            const [d,e,g,f] = c.getImageData(0, 0, 1, 1).data;
            return f ? `${this.rgbToHex(d, e, g)}` : GPPainter_.BACKGROUND_COLOR
        }
        thicknessKeyDown(a) {
        ...
        thicknessMove(a, b, c, d) {
            const e = "down / right" === this.s.upThicknessDirection ? 1 : -1;
            return g=>{
                const [f,h] = this.getCoords(g);
                g = Math.round(Math.max(Math.min(this.thickness + ("horizontal" === this.s.thicknessAxis ? f - c : h - d) * e, this.s.maxThickness), this.s.minThickness));
                c = f;
                d = h;
                g && (this.thickness = g,
                this.iface.updateThickness(g),
        ...
        opacityKeyDown(a) {
            ...
            document.addEventListener("keyup", this.opacityKeyUp, {
                once: !0
            })
        }
        opacityKeyUp(a) {
        ...
        opacityMove(a, b, c) {
            const d = "horizontal" === this.s.opacityAxis
              , e = `client${d ? "X" : "Y"}`
              , g = "up / left" === this.s.upOpacityDirection ? -1 : 1
              , f = this.s.opacitySensitivity * (d ? window.screen.width / 1920 : window.screen.height / 1080)
              , h = 100 * this.opacity / f;
            let k = a[e] * g;
            return l=>{
                l = l[e] * g;
                const m = (l + h - k) * f;
                0 > m ? k = l + h : 100 < m && (k = l + h - 100 / f);
        ...
        brightnessMove(a, b, c, d, e) {
            const g = "horizontal" === this.s.brightnessAxis
              , f = `client${g ? "X" : "Y"}`
              , h = "up / left" === this.s.upBrightnessDirection ? -1 : 1
              , k = this.s.brightnessSensitivity * (g ? window.screen.width / 1920 : window.screen.height / 1080)
              , l = 100 * this.brightness / k;
            let m = a[f] * h;
            return n=>{
                n = n[f] * h;
                const p = (n + l - m) * k;
                0 > p ? m = n + l : 100 < p && (m = n + l - 100 / k);
                this.brightness = n = Math.max(.01, Math.min(1, Math.round(p) / 100));
        ...
        handDown(a, b) {
            if (b || this.isHand && 0 === a.button)
                ...
                this.stroke.addEventListener("pointerup", c=>{
                    this.stroke.removeEventListener("pointermove", this.handMoveHandler);
        ...
        zoomKeyUp(a) {
            this.isZooming && (this.renderPointer(this.pointerX, this.pointerY, null, this.thickness),
            this.isZooming = !1)
        }
        zoomDown(a) {
        ...
        zoomMove(a, b, c, d, e, g) {
            const f = "up / left" === this.s.zoomInDirection ? 1 : -1;
            return h=>{
                const k = h.pageX;
                h = h.pageY;
                const l = ("horizontal" === this.s.zoomAxis ? k - e : h - g) * f;
        ...
        mirrorStrokeCoords(a) {
            if (a.length)
                return Array.isArray(a[0]) ? a.map(([b,c])=>[this.width / this.density - b, c]) : a.map(b=>b % 2 ? b : this.width / this.density - b)
        }
        resetMirror() {
        ...
        circleFilledTool() {
            this.gpproxy.isAnimateMode() || (this.setTool(GPPainter_.TOOL.CIRCLE_FILLED),
            this.iface.updateToolbar(this.tool),
            this.updatePointer())
        }
        fillTool() {
            this.gpproxy.isAnimateMode() || (this.setTool(GPPainter_.TOOL.FILL),
            this.iface.updateToolbar(this.tool),
            this.updatePointer())
        }
        noteTool() {
        ...
        undo() {
            let a, b = !0, c, d = [];
            do {
                if (!this.history.length || 11 === this.history.at(-1)[0])
                    return;
                a = this.history.pop();
                this.undos.push(a);
                b ? (c = a,
        ...
        toolCentering(a) {
            if (!this.isToolCentering) {
                ...
                var b = c=>{
                    c.code === a.code && (this.isToolCentering = !1,
        ...
        symmetry(a) {
            if (!this.isDrawing) {
                ...
                if (this.isSymmetryEnabled) {
                    const c = d=>{
                        d.code === a.code && (this.isSymmetryGuidesMoved || (this.isSymmetryEnabled = !1,
                        this.symmetryGuides.classList.remove("shown_"),
                    ...
                    this.iface.updateSymmetryPanel(this.isSymmetryEnabled);
                var b = c=>{
                    c.code === a.code && (this.isSymmetryGuidesEditable = this.isSymmetryGuidesMoved = !1,
                    this.symmetryGuides.classList.remove("editable_"),
                    document.removeEventListener("keyup", b))
                }
                ;
        ...
        symmetryGuidesDownHandler(a) {
            function b(d) {
                const [e,g] = d.touches ? [d.touches[0].clientX, d.touches[0].clientY] : [d.clientX, d.clientY];
                d = d.target.getBoundingClientRect();
                let[f,h] = [Math.round((e - d.left) / c), Math.round((g - d.top) / c)];
                this.isMirrored && (f = GPPainter_.ORIGINAL_WIDTH - f);
                this.updateSymmetryGuides(Math.max(0, Math.min(GPPainter_.ORIGINAL_WIDTH, f)), Math.max(0, Math.min(GPPainter_.ORIGINAL_HEIGHT, h)))
            }
        ...
        drawSymmetryGuides(a=this.symmetryGuideX, b=this.symmetryGuideY) {
            ...
            case GPPainter_.SYMMETRY_MODES.RADIAL:
                ...
                for (var d = -(Math.PI / 2); d < 1.5 * Math.PI; d += this.radiansPerSymmetryRadialGuide) {
                    var e = Math.cos(d) * GPPainter_.SYMMETRY_GUIDES_RADIUS
                      , g = Math.sin(d) * GPPainter_.SYMMETRY_GUIDES_RADIUS;
                    c.moveTo(a, b);
                    c.lineTo(e + a, g + b)
                }
                break;
            case GPPainter_.SYMMETRY_MODES.MANDALA:
                for (d = 1.5 * Math.PI,
                e = -(Math.PI / 2); e < d; e += this.radiansPerSymmetryMandalaGuide) {
                    g = Math.cos(e) * GPPainter_.SYMMETRY_GUIDES_RADIUS;
                    const f = Math.sin(e) * GPPainter_.SYMMETRY_GUIDES_RADIUS;
                    c.moveTo(a, b);
                    c.lineTo(g + a, f + b)
                }
            }
        ...
        palette(a) {
            ...
            if (c >= b.left && c <= b.right && d >= b.top && d <= b.bottom) {
                ...
                const e = g=>{
                    g.code === a.code && (this.colorPicker.hide(),
        ...
        zoomToPoint(a) {
            ...
            1 !== a ? (this.resetZoom(),
            this.clearPointer(),
            this.isZoomedToPoint = !1) : (a = this.s.maxZoomToPoint,
            this.zoomer.panTo({
        ...
        grayscale() {
            this.container.classList.toggle("grayscale_")
        }
        toggleReference() {
        ...
        drawFunction(a, b, c=this.density, d=!0, e=!0, f=!1) {
            f && (a.beginPath(),
            a.rect(0, 0, 1, 1),
            a.fill());
            ...
            if (b) {
                ...
                let H = !0
                  ...
                  , R = void 0;
                try {
                    for (var g, k = b[Symbol.iterator](); !(H = (g = k.next()).done); H = !0) {
                        const O = g.value
                          , P = O[0]
                          , t = (O[1],
                        O.slice(2));
                        if (10 != P) {
                            ...
                            a.save();
                            if (12 == P)
                                d ? a.clearRect(0, 32 * c, 758 * c, 424 * c) : (a.fillStyle = "#FFFFFF",
                                a.beginPath(),
                                a.rect(0, 32 * c, 758 * c, 424 * c),
                                a.fill());
                            else if (8 != P) {
                                ...
                                if (2 < t.length)
                                    ...
                                    case 1:
                                        ...
                                        a.beginPath();
                                        a.moveTo(...b);
                                        for (h = 2; h < t.length; h++) {
                                            b = [t[h][0], t[h][1]];
                                            var p = [t[h - 1][0], t[h - 1][1]];
                                            a.quadraticCurveTo(p[0], p[1], p[0] + (b[0] - p[0]) / 2, p[1] + (b[1] - p[1]) / 2)
                                        }
                                        a.lineTo(b[0], b[1]);
                                        a.stroke();
                                        break;
                                    case 2:
                                        ...
                                        a.lineWidth = t[0] * c;
                                        b = [t[1][0], t[1][1]];
                                        d && (a.globalCompositeOperation = "destination-out");
                                        a.beginPath();
                                        a.moveTo(...b);
                                        for (h = 2; h < t.length; h++) {
                                            b = [t[h][0], t[h][1]];
                                            var m = [t[h - 1][0], t[h - 1][1]];
                                            a.quadraticCurveTo(m[0], m[1], m[0] + (b[0] - m[0]) / 2, m[1] + (b[1] - m[1]) / 2)
                                        }
                                        a.lineTo(b[0], b[1]);
                                        a.stroke();
                                        d && (a.globalCompositeOperation = "source-over");
                                        break;
                                    case 3:
                                        var n = t[0];
                                        a.strokeStyle = n[0];
                                        ...
                                        a.lineWidth *= c;
                                        a.beginPath();
                                        a.moveTo(t[1][0], t[1][1]);
                                        a.lineTo(t[2][0], t[2][1]);
                                        a.stroke();
                                        break;
                                    case 4:
                                        var r = t[0];
                                        ...
                                        a.lineWidth *= c;
                                        a.beginPath();
                                        a.rect(t[1][0], t[1][1], t[2][0] - t[1][0], t[2][1] - t[1][1]);
                                        a.stroke();
                                        break;
                                    case 6:
                                        var q = t[0];
                                    ...
                                    case 5:
                                        ...
                                        var B = (t[2][0] - t[1][0]) / 2
                                          , z = (t[2][1] - t[1][1]) / 2
                                          , v = Math.round(t[1][0] + B)
                                          , w = Math.round(t[1][1] + z)
                                          , y = (Math.sqrt(2) - 1) / 3 * 4;
                                        a.beginPath();
                                        a.moveTo(v, w - z);
                                        a.bezierCurveTo(v + y * B, w - z, v + B, w - y * z, v + B, w);
                                        a.bezierCurveTo(v + B, w + y * z, v + y * B, w + z, v, w + z);
                                        a.bezierCurveTo(v - y * B, w + z, v - B, w + y * z, v - B, w);
                                        a.bezierCurveTo(v - B, w - y * z, v - y * B, w - z, v, w - z);
                                        a.stroke();
                                        break;
                                    case 7:
                                        ...
                                        var A = (t[2][0] - t[1][0]) / 2
                                          , x = (t[2][1] - t[1][1]) / 2
                                          , E = Math.round(t[1][0] + A)
                                          , C = Math.round(t[1][1] + x)
                                          , G = (Math.sqrt(2) - 1) / 3 * 4;
                                        a.beginPath();
                                        a.moveTo(E, C - x);
                                        a.bezierCurveTo(E + G * A, C - x, E + A, C - G * x, E + A, C);
                                        a.bezierCurveTo(E + A, C + G * x, E + G * A, C + x, E, C + x);
                                        a.bezierCurveTo(E - G * A, C + x, E - A, C + G * x, E - A, C);
                                        a.bezierCurveTo(E - A, C - G * x, E - G * A, C - x, E, C - x);
                                        a.fill()
                                    }
                                else if (![6, 7, 11].includes(P)) {
                                    switch (P) {
                                    case 2:
                                        a.fillStyle = "#FFFFFF";
                                        a.lineWidth = t[0] * c;
                                    ...
                                    a.beginPath();
                                    a.arc(b[0], b[1], a.lineWidth / 2, 0, 2 * Math.PI);
                                    a.fill();
                                    2 == P && d && (a.globalCompositeOperation = "source-over")
                                }
                            } else {
                                var M = t[0];
                                a.fillStyle = M[0];
                                a.globalAlpha = M[1];
                                a.beginPath();
                                for (b = 1; b < t.length; b += 5)
                                    a.rect(t[b] * c, t[b + 1] * c, t[b + 2] * c, t[b + 3] * c);
                                a.fill()
                            }
                            a.restore()
                        } else
                ...
                g = void 0;
                try {
                    for (var N, J = f[Symbol.iterator](); !(d = (N = J.next()).done); d = !0) {
                        var F = N.value;
                        ...
                        a.beginPath();
                        a.moveTo(...K);
                        for (f = 2; f < F.length; f++) {
                            K = [F[f][0], F[f][1]];
                            var L = [F[f - 1][0], F[f - 1][1]];
                            a.quadraticCurveTo(L[0], L[1], L[0] + (K[0] - L[0]) / 2, L[1] + (K[1] - L[1]) / 2)
                        }
                        a.lineTo(K[0], K[1]);
                        a.stroke()
                    }
        ...
        getFillData(a, b) {
            ...
            return this.getFillRects(c, a, b, d, this.canvas.width, this.canvas.height).map((e,g)=>4 > g % 5 ? Math.round(e / this.density) : e)
        }
        getFillRects(a, b, c, d, e, g) {
            var f = function(u, v, y) {
                var w = v
                  , z = y;
                if (m(v, y, u)) {
                    for (; m(w + 1, z, u); )
              ...
              , m = function(u, v, y) {
                ...
                u = r.slice(u, u + 4);
                v = Math.abs(y[1] - u[1]);
                var w = Math.abs(y[2] - u[2])
                  , z = Math.abs(y[3] - u[3]);
                return 20 > Math.abs(y[0] - u[0]) && 20 > v && 20 > w && 20 > z || 0 == u[3] && 255 == y[0] && 255 == y[1] && 255 == y[2] || 0 == y[3] && 255 == u[0] && 255 == u[1] && 255 == u[2]
            }
              , n = function(u) {
                for (var v = u[0], y = u[1], w = v + u[2], z = y + u[3]; v < w; v++)
                    for (var x = y; x < z; x++)
                        p[v][x] = !0;
                return u
            };
            ...
            var r = a.getImageData(0, 0, e, g).data;
            a = 4 * (b + c * e);
            a = [r[a], r[a + 1], r[a + 2], r[a + 3]];
            d = [];
            for (var q = 0; q <= e; q++)
                d[q] = [];
            for (; m(b - 1, c, a); )
            ...
            var B = q.w
              , A = [].concat(n([q.x, q.y, q.w + 1, q.h + 1]), [0]);
            do {
                b = 0;
                for (2 == c.ref && (b += c.andada); b <= c.h; )
                    -1 != (t = (q = l(a, c.x + c.w + 1, c.y + c.h - b)).h) ? (d[t].push({
                        x: q.x,
                        y: q.y,
                        w: q.w,
                        h: q.h,
                    ...
                    A.push.apply(A, n([q.x, q.y, q.w + 1, q.h + 1]).concat([c.stack])),
                    t > B && (B = t),
                    b += t) : b++;
                b = 0;
                for (1 == c.ref && (b += c.andada); b <= c.h; )
                    -1 != (t = (q = k(a, c.x - 1, c.y + b)).h) ? (d[t].push({
                        x: q.x,
                        y: q.y,
                        w: q.w,
                        h: q.h,
                ...
                for (4 == c.ref && (b += c.andada); b <= c.w; )
                    -1 != (t = (q = f(a, c.x + b, c.y + c.h + 1)).w) ? (d[t].push({
                        x: q.x,
                        y: q.y,
                        w: q.w,
                        h: q.h,
                ...
                for (3 == c.ref && (b += c.andada); b <= c.w; )
                    -1 != (t = (q = h(a, c.x + c.w - b, c.y - 1)).w) ? (d[t].push({
                        x: q.x,
                        y: q.y,
                        w: q.w,
                        h: q.h,
        ...
        setTimer() {
            ...
            this.timer.settings.runAfterTurnStart && this.gpproxy.isGameTime(GPProxy_.GAME_TIME.HOSTS_DECISION) && this.gpproxy.isHost() && this.timer.start())
        }
        stopTimer() {
            this.timer && this.timer.reset()
        }
        ...
        unsign() {
            null !== this.mStrokeId && (this.gpproxy.undo(this.mStrokeId, !0),
            this.mStrokeId = null,
            this.isSigned = !1)
        }
        buildMStroke() {
            var a = this.gpproxy.getGameCode();
            const {nick: b} = this.gpproxy.getUser()
              , c = Date.now().toString();
            a = this.stringToCoords(`\x00${a}@${this.formatUsername(b)}@${c}\x00`);
        ...
        stringToCoords(a) {
            ...
            for (let c = 0; c < b.length; c += 2)
                a.push([b[c] + GPPainter_.ORIGINAL_WIDTH + GPPainter_.M_STROKE_OFFSET, b[c + 1] + GPPainter_.ORIGINAL_HEIGHT + GPPainter_.M_STROKE_OFFSET]);
            return a
        }
        formatUsername(a) {
            return this.gpproxy.isDiscordAuth() ? a : a.toLowerCase()
        ...
        saveSettings() {
            localStorage.setItem("gp_painter", JSON.stringify(this.s))
        }
        getSettings() {
            return Object.assign({}, this.s)
        }
        getDefaultSettings() {
            return Object.assign({}, this.parseUISettings(GPPainter_.UI_SETTINGS))
        }
        updateSettings(a) {
            "minZoom"in a && this.zoomer.setMinScale(a.minZoom);
            "maxZoom"in a && this.zoomer.setMaxScale(a.maxZoom);
            "fixedScreenSize"in a && this.iface.toggleFixedScreenSize(a.fixedScreenSize);
            ("extendedPalettePanel"in a || "extendedPaletteName"in a) && this.iface.updateExtendedPalettePanel(this.s.extendedPalettePanel, this.s.extendedPaletteName);
            "colorPickerPanel"in a && this.iface.updateColorPickerPanel(a.colorPickerPanel);
            "colorPickerHuePosition"in a && this.initColorPicker({
            ...
            ("panelsBackgroundColor"in a || "panelsBackgroundOpacity"in a) && this.iface.updatePanelsBackground(this.s.panelsBackgroundColor, this.isDisabled ? Math.max(this.s.panelsBackgroundOpacity - 10, 0) : this.s.panelsBackgroundOpacity);
            ("panelsElementsColor"in a || "panelsElementsOpacity"in a) && this.iface.updatePanelsElements(this.s.panelsElementsColor, this.isDisabled ? Math.max(this.s.panelsElementsOpacity - 30, 0) : this.s.panelsElementsOpacity);
            ...
            "autoHideHeaderElements"in a && this.iface.setAutoHideHeaderState(a.autoHideHeaderElements);
            "autoHideHeaderDelay"in a && this.iface.setAutoHideHeaderDelay(a.autoHideHeaderDelay);
            "symmetryGuidesColor"in a && this.setSymmetryGuidesColor(a.symmetryGuidesColor);
            "symmetryGuidesOpacity"in a && this.setSymmetryGuidesOpacity(a.symmetryGuidesOpacity);
            "symmetryGuidesWidth"in a && this.setSymmetryGuidesWidth(a.symmetryGuidesWidth)
        }
        parseUISettings(a) {
            const b = {};
            for (let c in a)
        ...
        getUISettings() {
            return GPPainter_.UI_SETTINGS
        }
        getUISetting(a) {
            return GPPainter_.UI_SETTINGS[a] || null
        }
        saveBindings() {
        ...
        getDefaultBindings() {
            return [JSON.parse(JSON.stringify(GPPainter_.DEFAULT_BINDINGS)), this.bindingsLabels]
        }
        updateBindings(a) {
            this.bindings = a;
    ...
    class GPDrawInterface_ extends EventTarget {
        ...
        static SELECTORS = {
            ...
            COLOR: ".colorslist .color, .marks .color",
            INPUT_COLOR: '.colors input[type="color"]',
            OPTIONS: ".options",
        ...
        static PALETTES = Object.assign({
            ["default"]: this.DEFAULT_COLOR_SET,
            custom: []
        ...
        constructor(a, b, c) {
            ...
            this.style = document.documentElement.style;
            this.painter = a;
            this.initialSettings = a.getSettings();
            ...
            this.toolsContainerClickHandler = this.toolsContainerClickHandler.bind(this);
            this.colorsContainerClickHandler = this.colorsContainerClickHandler.bind(this);
            this.colorInputInputHandler = this.colorInputInputHandler.bind(this);
            this.colorInputChangeHandler = this.colorInputChangeHandler.bind(this);
            this.opacityChangeHandler = this.opacityChangeHandler.bind(this);
            this.color2InputChangeHandler = this.color2InputChangeHandler.bind(this);
            this.thicknessesContainerClickHandler = this.thicknessesContainerClickHandler.bind(this);
            this.readyBtnClickHandler = this.readyBtnClickHandler.bind(this);
            this.saveBtnClickHandler = this.saveBtnClickHandler.bind(this);
            this.symmetryModesClickHandler = this.symmetryModesClickHandler.bind(this);
            this.settingsBtnHandler = this.settingsBtnHandler.bind(this);
            this.resetSettings = this.resetSettings.bind(this);
            this.restoreSettings = this.restoreSettings.bind(this);
            this.renderSettingsHandler = this.renderSettingsHandler.bind(this);
            this.resetBindings = this.resetBindings.bind(this);
            this.renderBindingsHandler = this.renderBindingsHandler.bind(this);
            this.setBindingHandler = this.setBindingHandler.bind(this);
            this.keyUpHandler = this.keyUpHandler.bind(this);
            this.keyDownHandler = this.keyDownHandler.bind(this);
            this.keyHandler = this.keyHandler.bind(this);
            this.resizeHandler = this.resizeHandler.bind(this);
            this.paletteKeyHandler = this.paletteKeyHandler.bind(this);
            this.onPaletteDragStart = this.onPaletteDragStart.bind(this);
            this.onPaletteDragOver = this.onPaletteDragOver.bind(this);
            this.onPaletteDragEnter = this.onPaletteDragEnter.bind(this);
            this.onPaletteDragLeave = this.onPaletteDragLeave.bind(this);
            this.onPaletteDrop = this.onPaletteDrop.bind(this);
            this.resetKeys = this.resetKeys.bind(this);
        ...
        terminate() {
            this.isInit && (this.tools = {},
            this.thicknesses = {},
            this.currentThickness = this.currentTool = null,
            this.toolsContainer.removeEventListener("click", this.toolsContainerClickHandler),
            ...
            this.nativeOpacity.removeEventListener("change", this.opacityChangeHandler),
            this.opacity.removeEventListener("change", this.opacityChangeHandler),
            this.thicknessesContainer.removeEventListener("click", this.thicknessesContainerClickHandler),
            this.readyBtn.removeEventListener("click", this.readyBtnClickHandler, !0),
            this.symmetryModes.removeEventListener("change", this.symmetryModesClickHandler),
            ...
            this.saveBtn && this.saveBtn.removeEventListener("click", this.saveBtnClickHandler, !0),
            this.painter.reference && this.referenceBtn.remove(),
            this.core && this.core.classList.remove("background_"),
            this.readyWarning && this.readyWarning.remove(),
        ...
        init() {
            ...
            this.toolsContainer.querySelectorAll(a.TOOL).forEach(m=>{
                for (let n in GPDrawInterface_.TOOLS)
                    if (m.classList.contains(n)) {
                        m.dataset.toolid = GPDrawInterface_.TOOLS[n].id;
                        this.tools[n] = m;
                        break
                    }
            }
            ...
            this.colorsContainer = document.querySelector(a.COLORS);
            this.colorsContainer.addEventListener("click", this.colorsContainerClickHandler, !0);
            this.colorsContainer.querySelectorAll(a.COLOR).forEach(m=>{
                const [,n,p,r] = m.style.cssText.match(/\((\d+),\s(\d+),\s(\d+)\)/).map(q=>+q);
                m.dataset.color = this.painter.rgbToHex(n, p, r)
            }
            );
            this.nativeColorInput = document.querySelector(a.INPUT_COLOR);
            const {colorPickerPanel: b, extendedPalettePanel: c, extendedPaletteName: d} = this.painter.getSettings();
            b && this.initColorPickerPanel();
            c && (this.initExtendedPalettePanel(d),
            GPDrawInterface_.PALETTES[d].length || this.painter.setPaletteName("default"));
            document.addEventListener("keydown", this.paletteKeyHandler, !0);
            document.addEventListener("keyup", this.paletteKeyHandler, !0);
            window.addEventListener("blur", this.resetKeys);
            window.addEventListener("focus", this.resetKeys);
            this.screen.classList.toggle("gp-custom-tools_", !(!this.palette && !this.colorPicker));
            var e = this.colorsContainer.querySelector(a.MARK_COLOR);
            this.screen.classList.toggle("color-marks_", e);
            this.colorInput = document.createElement("input");
            this.colorInput.type = "color";
            this.colorInput.className = "gl-painter-color_";
            this.colorInput.classList.add("gp-ui-color_");
            this.colorInput.value = this.painter.color;
            ...
            this.color2Input.className = "gl-painter-color2_";
            this.color2Input.classList.add("gp-ui-color_");
            this.color2Input.value = this.painter.color2;
            ...
            this.opacity = this.initOpacityPanel(this.painter.s.minOpacity, this.painter.opacity, this.optionsContainer.querySelector(a.OPACITY));
            e = this.optionsContainer.querySelectorAll(a.THICKNESS);
            e.forEach((m,n)=>{
                n = GPDrawInterface_.THICKNESSES[n];
                m.dataset.value = n;
                this.thicknesses[n] = m;
                m.classList.remove("sel");
                this.painter.thickness === n && (m.classList.add("sel"),
                this.currentThickness = m)
            }
            );
            this.thicknessesContainer = e[0].parentElement;
            ...
            this.painter.addEventListener("stroke", m=>{
                this.readyBtn.hasAttribute("disabled") && this.readyBtn.removeAttribute("disabled")
            }
            , {
                once: !0
            });
            this.painter.addEventListener("stroke_redo", m=>{
                this.readyBtn.hasAttribute("disabled") && this.readyBtn.removeAttribute("disabled")
            }
            , {
                once: !0
            ...
            this.updateReadyBtn();
            (this.saveBtn = document.querySelector(a.SAVE_BTN)) && this.saveBtn.addEventListener("click", this.saveBtnClickHandler, !0);
            ...
            this.symmetryGuidesCount.addEventListener("wheel", m=>{
                m.currentTarget.dataset.count = this.painter.getSymmetryMode() === GPPainter_.SYMMETRY_MODES.RADIAL ? this.painter.changeSymmetryRadialGuidesCount(m.deltaY) : this.painter.changeSymmetryMandalaGuidesCount(m.deltaY)
            }
            );
            this.symmetryGuidesCount.addEventListener("pointerdown", m=>{
                let n = m.clientY;
                const p = r=>{
                    const q = r.clientY - n;
                    Math.abs(q) >= GPPainter_.SYMMETRY_GUIDES_COUNT_SENSITIVITY && (r.currentTarget.dataset.count = this.painter.getSymmetryMode() === GPPainter_.SYMMETRY_MODES.RADIAL ? this.painter.changeSymmetryRadialGuidesCount(q) : this.painter.changeSymmetryMandalaGuidesCount(q),
                    n = r.clientY)
                }
                ;
                this.symmetryGuidesCount.setPointerCapture(m.pointerId);
                this.symmetryGuidesCount.addEventListener("pointermove", p);
                this.symmetryGuidesCount.addEventListener("pointerup", r=>{
                    this.symmetryGuidesCount.removeEventListener("pointermove", p)
                }
                , {
                    once: !0
                })
            ...
            this.painter.getSymmetryModes().forEach(m=>{
                var n = GPPainter_.SYMMETRY_MODES[m];
                const p = `sm-mode-${n}_`
                  , r = document.createElement("input");
                r.type = "radio";
                r.name = "sm-group_";
                r.id = p;
                r.checked = n === this.painter.getSymmetryMode();
                r.dataset.modeId = n;
                this.symmetryModes.appendChild(r);
                n = document.createElement("label");
                n.className = `${m.toLowerCase()}_ btn_`;
                n.setAttribute("for", p);
                n.innerHTML = GPDrawInterface_.SYMMETRY_ICONS[m];
                this.symmetryModes.appendChild(n)
            }
            );
            ...
            this.settingsContent = document.createElement("form");
            ...
            const {fixedScreenSize: g, hideHeaderBackground: f, headerInstructionsColor: h, autoHideHeaderElements: k, autoHideHeaderDelay: l} = this.painter.getSettings();
            this.toggleFixedScreenSize(g);
            this.toggleHeaderBackground(f);
            this.updateHeaderPhraseColor(h);
            this.setAutoHideHeaderState(k);
            this.setAutoHideHeaderDelay(l);
        ...
        resizeHandler(a) {
            a = window.innerWidth;
            if (this.lastViewportWidth <= GPDrawInterface_.MOBILE_MAX_WIDTH && a > GPDrawInterface_.MOBILE_MAX_WIDTH || this.lastViewportWidth > GPDrawInterface_.MOBILE_MAX_WIDTH && a <= GPDrawInterface_.MOBILE_MAX_WIDTH)
                this.terminate(),
                this.init();
        ...
        initExtendedPalettePanel(a) {
            this.currentPaletteName = a;
            this.currentColorSet = GPDrawInterface_.PALETTES[a];
            this.isCustomPalette = "default" !== a;
            this.paletteKeys = new Set;
            const b = ()=>this.painter.getColor().slice(1);
            this.palette && this.palette.remove();
            this.palette = document.createElement("div");
            this.palette.className = "gp-palette-set_";
            this.palette.classList.toggle("custom_", this.isCustomPalette);
            this.palette.toggleAttribute("disabled", this.painter.isDisabled);
            this.palette.dataset.id = -1;
            this.paletteBackground = document.createElement("div");
            this.paletteBackground.className = "background_";
            this.paletteBackground.innerHTML = GPDrawInterface_.PALETTE_BACKGROUND_ICON;
            ...
            this.isCustomPalette && (this.palette.draggable = !0,
            ...
            this.palette.addEventListener("auxclick", c=>{
                this.isCustomPalette && 1 === c.button && this.currentColorSet.length && (this.downloadPalette(),
                c.preventDefault())
            }
            );
            this.palette.addEventListener("pointerdown", c=>{
                if (0 === c.button)
                    if (this.isCustomPalette) {
                        const d = c.target.classList.contains("color_")
                          , e = this.currentColorSet
                          , g = d ? this.getColorIndex(c.target) : -1;
                        c.shiftKey ? (d ? (e.splice(g, 0, b()),
                        e.length = Math.min(e.length, GPDrawInterface_.MAX_PALETTE_SIZE)) : e.length < GPDrawInterface_.MAX_PALETTE_SIZE && e.push(b()),
                        this.renderPaletteColorSet(),
                        this.saveCustomPalette()) : c.ctrlKey ? (d ? e.splice(g, 1) : e.length && e.pop(),
                        this.renderPaletteColorSet(),
                        this.saveCustomPalette()) : c.altKey ? d && this.renderPaletteColorSet() : d && this.selectPaletteColor(c.target)
                    } else
                        this.selectPaletteColor(c.target)
            }
            );
            this.palette.addEventListener("wheel", c=>{
                const d = Object.keys(GPDrawInterface_.PALETTES)
                  , e = d.findIndex(g=>g === this.currentPaletteName);
                if (~e) {
                    const g = d.length;
                    c = d[0 > c.deltaY ? (e + g - 1) % g : (e + 1) % g]
                } else
                    c = "default";
                this.painter.setPaletteName(c)
            }
            );
            (this.colorPicker?.getElement() || this.nativeColorInput).before(this.palette);
            this.screen.classList.add("gp-extended-palette-panel_")
        }
        renderPaletteColorSet() {
            const a = this.currentColorSet;
            a.length = Math.min(a.length, GPDrawInterface_.MAX_PALETTE_SIZE);
            ...
            a.forEach((e,g)=>{
                ...
                this.isCustomPalette && (f.draggable = !0,
                f.dataset.id = g);
                this.paletteColors.appendChild(f)
            }
            )
        }
        saveCustomPalette() {
            const {default: a, ...b} = GPDrawInterface_.PALETTES;
            localStorage.setItem(GPDrawInterface_.CUSTOM_COLOR_SET_STORAGE, JSON.stringify(b))
        }
        calculateColorSize(a) {
            const b = [3, 4, 5, 6, 8];
            var c = b.map((g,f)=>Math.floor(292 / (148 / b[f])) * g).findIndex(g=>a <= g)
              , d = ~c ? c : b.length - 1;
        ...
        selectPaletteColor(a) {
            this.painter.setColor(a.dataset.color);
        ...
        paletteKeyHandler(a) {
            if (this.palette && !a.repeat) {
                var b = GPDrawInterface_.PALETTE_KEY_STATES;
                a.key in b && (a.getModifierState(a.key) ? this.paletteKeys.add(a.key) : this.paletteKeys.delete(a.key),
                (a = Object.keys(b).find(c=>this.paletteKeys.has(c))) ? this.palette.dataset.state = b[a] : delete this.palette.dataset.state)
            }
        }
        resetKeys(a) {
            this.palette && (this.paletteKeys.clear(),
        ...
        buildSerializedPalette() {
            const a = `gp-palette by ${this.gpproxy.getUsername()} (${this.getPaletteHash()}).${GPDrawInterface_.PALETTE_FILE_EXT}`
        ...
        getPaletteHash() {
            let a = 0;
            this.currentColorSet.forEach(b=>{
        ...
        onPaletteDragStart(a) {
            if (a.shiftKey || a.ctrlKey || a.altKey || !this.currentColorSet.length)
                a.altKey && a.target !== a.currentTarget ? (a.dataTransfer.setData(GPDrawInterface_.TYPE_PALETTE_COLOR_ID, a.target.dataset.id),
                a.dataTransfer.effectAllowed = "move") : a.preventDefault();
            else {
                const {url: b, filename: c} = this.buildSerializedPalette();
                a.dataTransfer.setData("DownloadURL", `${GPDrawInterface_.TYPE_PALETTE}:${c}:${b}`);
                a.dataTransfer.setDragImage(GPDrawInterface_.DRAG_PALETTE_IMAGE, 0, 0)
            }
        }
        onPaletteDragOver(a) {
            a.preventDefault();
        ...
        onPaletteDragEnter(a) {
            ...
            case GPDrawInterface_.TYPE_PALETTE_COLOR_ID:
        ...
        onPaletteDrop(a) {
            switch (a.dataTransfer.types[0]) {
            case GPDrawInterface_.TYPE_PALETTE_COLOR_ID:
                var b = a.dataTransfer.getData(GPDrawInterface_.TYPE_PALETTE_COLOR_ID);
                if (b === a.target.dataset.id)
                    break;
                this.moveColor(b, a.target.dataset.id);
                this.saveCustomPalette();
                break;
            case "Files":
                if (b = Array.from(a.dataTransfer.files).find(this.isPaletteFile)) {
                    const c = new FileReader;
                    this.isPSColorSwatchFile(b) ? (c.addEventListener("loadend", d=>{
                        try {
                            const e = GPAcoDecoder_.decode(c.result);
                            this.loadPaletteColors(e)
                        } catch (e) {
                            console.error(e)
                        }
                    }
                    ),
                    c.readAsArrayBuffer(b)) : (c.addEventListener("loadend", d=>{
                        try {
                            const e = this.parsePaletteFile(c.result);
                            this.loadPaletteColors(e)
                        } catch (e) {
                            console.error(e)
                        }
        ...
        loadPaletteColors(a) {
            a && (this.currentColorSet.length = 0,
            this.currentColorSet.push(...a),
            this.renderPaletteColorSet(),
            this.saveCustomPalette())
        }
        parsePaletteFile(a) {
            ...
            for (let c = 0; c < a.length; c++) {
                ...
                if (d && (b.push(d),
                b.length === GPDrawInterface_.MAX_PALETTE_SIZE))
                    break
            }
            return b
        }
        isPaletteFile(a) {
            ...
            return [GPDrawInterface_.PALETTE_FILE_EXT, GPDrawInterface_.PS_COLOR_SWATCH_EXT].some(c=>b.endsWith(`.${c}`))
        }
        isPSColorSwatchFile(a) {
            return a.name.toLowerCase().endsWith(`.${GPDrawInterface_.PS_COLOR_SWATCH_EXT}`)
        }
        moveColor(a, b) {
            this.currentColorSet.splice(~b ? b : this.currentColorSet.length, 0, this.currentColorSet.splice(a, 1)[0]);
            this.renderPaletteColorSet()
        }
        initColorPickerPanel() {
            this.colorPicker?.getElement() && this.colorPicker.getElement().remove();
            this.colorPicker = new GPColorPicker_(144,125);
            this.colorPicker.setColor(this.painter.color);
            this.colorPicker.getElement().toggleAttribute("disabled", this.painter.isDisabled);
            this.colorPicker.addEventListener("color", ({detail: {color: a}})=>{
                this.painter.setColor(a, !0)
            }
            );
        ...
        disableInterface() {
            ...
            this.colorsContainer.classList.add("disabled");
            ...
            this.colorInput.value = this.painter.s.panelsBackgroundColor;
            this.color2Input.value = this.painter.s.panelsBackgroundColor;
            this.palette && this.palette.setAttribute("disabled", "");
            this.colorPicker && this.colorPicker.getElement().setAttribute("disabled", "");
            this.updatePanelsBackground(this.painter.s.panelsBackgroundColor, Math.max(this.painter.s.panelsBackgroundOpacity - 10, 0))
        }
        enableInterface() {
            this.painter.enable();
            this.toolsContainer.classList.remove("disabled");
            this.colorsContainer.classList.remove("disabled");
            ...
            this.colorInput.value = this.painter.color;
            this.color2Input.value = this.painter.color2;
            this.palette && this.palette.removeAttribute("disabled");
            this.colorPicker && this.colorPicker.getElement().removeAttribute("disabled");
            this.updatePanelsBackground(this.painter.s.panelsBackgroundColor, this.painter.s.panelsBackgroundOpacity)
        }
        ...
        toolsContainerClickHandler(a) {
            if (a.target.classList.contains("tool")) {
                ...
                if (!a.disabled) {
                    ...
                    a.tumbler && (this.currentTool.classList.remove("sel"),
                    b.classList.add("sel"),
                    this.currentTool = b)
                }
            }
        ...
        colorsContainerClickHandler(a) {
            ...
            this.painter.setColor(a.target.dataset.color))
        }
        colorInputInputHandler(a) {
            this.painter.setColor(a.target.value)
        }
        colorInputChangeHandler(a) {
            this.painter.setColor(a.target.value)
        }
        color2InputChangeHandler(a) {
            this.painter.setColor2(a.target.value)
        }
        ...
        thicknessesContainerClickHandler(a) {
            a.stopPropagation();
            a.target.classList.contains("thickness") && (a = +a.target.dataset.value,
            this.painter.setThickness(a),
            this.updateThickness(a))
        }
        readyBtnClickHandler(a) {
            a.stopPropagation();
            this.painter.gpproxy.isGameTime(GPProxy_.GAME_TIME.HOSTS_DECISION) && this.painter.gpproxy.isHost() && this.painter.s.readyConfirmation && !this.painter.isReadyWarningShown ? this.showReadyWarning() : (this.painter.timer && this.painter.gpproxy.isGameTime(GPProxy_.GAME_TIME.HOSTS_DECISION) && this.painter.gpproxy.isHost() && this.painter.timer.reset(),
        ...
        settingsBtnHandler(a) {
            ...
            this.settingsPane.classList.toggle("hidden");
            this.screen.classList.toggle("gp-settings-shown_");
            this.renderSettings(this.painter.getSettings())
        }
        ...
        updateSymmetryGuidesCount(a) {
            switch (a) {
            case GPPainter_.SYMMETRY_MODES.RADIAL:
                this.symmetryGuidesCount.dataset.count = this.painter.getSettings().symmetryRadialGuidesCount;
                break;
            case GPPainter_.SYMMETRY_MODES.MANDALA:
                this.symmetryGuidesCount.dataset.count = this.painter.getSettings().symmetryMandalaGuidesCount
            }
        }
        ...
        renderSettings(a) {
            ...
            const b = document.createElement("div");
            b.className = "controls_ gp-ui-scrollbar_";
            b.addEventListener("scroll", e=>{
                this.settingsScrollPos = e.target.scrollTop
            }
            );
            this.settingsContent.appendChild(b);
            var c = document.createElement("div");
            c.className = "buttons_";
            this.settingsContent.appendChild(c);
            var d = document.createElement("div");
            d.className = "gp-ui-btn_ btn_ restore-btn_";
            d.textContent = this.l.RESTORE_SETTINGS_BTN_LBL;
            d.title = this.l.RESTORE_SETTINGS_BTN_TTL;
            d.addEventListener("click", this.restoreSettings);
            c.appendChild(d);
            d = document.createElement("div");
            d.className = "gp-ui-btn_ btn_ default-btn_";
            d.textContent = this.l.RESET_SETTINGS_BTN_LBL;
            d.title = this.l.RESET_SETTINGS_BTN_TTL;
            d.addEventListener("click", this.resetSettings);
            c.appendChild(d);
            c = document.createDocumentFragment();
            d = this.painter.getUISettings();
            for (let e in d) {
                const {type: g, args: f, description: h, text: k, inputTrigger: l} = this.painter.getUISetting(e) || {};
                if (e.startsWith("_")) {
                    d = document.createElement("div");
                    d.className = "label_";
                    d.textContent = k;
                ...
                d.className = "name_";
                d.title = h;
                d.textContent = e.split(/(?=[A-Z])/).join(" ");
                let m = document.createElement("div");
                m.className = "control_";
                let n;
                switch (g) {
                case "slider":
                    const p = document.createElement("div");
                    p.className = "preview_ gp-ui-slider-preview_";
                    p.textContent = a[e];
                    const [r,q,t] = f;
                ...
                n.addEventListener(l ? "input" : "change", p=>{
                    this.dispatchEvent(new CustomEvent("settings_updated",{
                        detail: {
                            settings: {
                                [p.target.name]: this.parseSettingsValue(p.target)
                            }
                        }
                    }))
                }
            ...
            b.appendChild(c);
            this.toggleScrollbar(b);
            b.scrollTop = this.settingsScrollPos
        }
        getInitialSettings() {
            return Object.assign({}, this.initialSettings)
        }
        parseSettingsValue(a) {
            switch (a.type) {
            case "range":
                return Number.parseFloat(a.value);
            case "checkbox":
        ...
        resetSettings(a) {
            a = this.painter.getDefaultSettings();
            this.renderSettings(a);
            this.dispatchEvent(new CustomEvent("settings_updated",{
                detail: {
                    settings: a
        ...
        renderBindings(a, b) {
            ...
            for (let g in a) {
                if (!this.painter.tools[g])
                    continue;
                g in b && (e = document.createElement("div"),
                e.className = "label_",
                e.textContent = b[g],
                d.appendChild(e));
                e = document.createElement("div");
                ...
                d.appendChild(e);
                const f = document.createElement("div");
                f.className = "keys-bindings_";
                a[g].length ? a[g].forEach((h,k)=>{
                    h = this.renderBindingKeys(g, k, h, f, c);
                    f.appendChild(h)
                }
                ) : (e = this.renderBindingKeys(g, -1, [], f, c),
                e.classList.add("empty_"),
                f.appendChild(e));
                d.appendChild(f)
            }
            c.appendChild(d);
        ...
        renderBindingKeys(a, b, c, d, e) {
            ...
            g.className = "keys-binding_";
            var f = document.createElement("div");
            f.className = "keys_";
            f.textContent = c;
            f.dataset.name = a;
            f.dataset.index = b;
            f.dataset.initialValue = c;
            f.addEventListener("click", this.setBindingHandler);
            g.appendChild(f);
            c = document.createElement("div");
            c.className = "buttons_";
            g.appendChild(c);
            ...
            f.addEventListener("click", h=>{
                h = this.renderBindingKeys(a, -1, [], d, e);
                d.appendChild(h);
            ...
            c.appendChild(f);
            f = document.createElement("div");
            f.className = "delete-btn_ btn_ gp-ui-btn_";
            f.textContent = "-";
            f.addEventListener("click", h=>{
                this.deleteBinding(a, b, g);
                this.toggleScrollbar(e)
            }
            );
            c.appendChild(f);
            f = document.createElement("div");
            f.className = "accept-btn_ btn_ gp-ui-btn_";
            f.textContent = "\u2713";
            f.addEventListener("click", h=>{
        ...
        keyHandler(a) {
            ...
            if (this.pressedKeys.size) {
                ...
                const b = this.isSameBindingKeys(this.currentKeys, this.pressedKeys) || this.isBindingExists(this.pressedKeys);
                a.classList.toggle("existed_", b)
            } else
                a.textContent = this.getPlaceholderKeys()
        }
        ...
        formatKey(a) {
            return a.replace(/^Key/, "").replace(/((?:Left)|(?:Right))$/, " ($1)")
        }
        toggleScrollbar(a) {
        ...
        updateThickness(a) {
            ...
            this.currentThickness && (this.currentThickness.classList.remove("sel"),
            this.currentThickness = null);
            a && (a.classList.add("sel"),
            this.currentThickness = a)
        }
        updateReadyBtn(a) {
            a ?? this.painter.gpproxy.isReady() ? (this.readyIcon.classList.replace("ready", "pencil"),
            this.readyLabel.textContent = this.painter.localization.edit) : (this.readyIcon.classList.replace("pencil", "ready"),
            this.readyLabel.textContent = this.painter.localization.ready)
        }
        updateColorPicker(a, b) {
            this.colorPicker && !b && this.colorPicker.setColor(a)
        }
        updateExtendedPalettePanel(a, b) {
            a ? this.initExtendedPalettePanel(b) : this.palette && (this.palette.remove(),
            this.palette = null,
            this.screen.classList.remove("gp-extended-palette-panel_"));
            this.screen.classList.toggle("gp-custom-tools_", !(!this.palette && !this.colorPicker))
        }
        updateColorPickerPanel(a) {
            a ? this.initColorPickerPanel() : this.colorPicker && (this.colorPicker.getElement().remove(),
        ...
        updatePanelsBackground(a, b) {
            ...
            const [g,f,h] = GPColorUtils_.rgbToHsv(c, d, e)
              , [k,l,m] = GPColorUtils_.hsvToRgb(Math.max(g - .04246122552758713, 0), Math.max(f - .012523565849717255, 0), Math.max(h - .05882352941176472, 0));
            this.style.setProperty("--gp-panels-elems2-color", `rgb(${k}, ${l}, ${m})`);
            this.painter.isDisabled && (this.updateColorInput(a),
            this.updateColor2Input(a))
        }
    ...
    class GPReference_ extends EventTarget {
        ...
        static INIT(a) {
            a.reference = new GPReference_(a.gpproxy,a.sm)
        }
        constructor(a, b) {
            super();
            this.gpproxy = a;
            ...
            this.fm.addEventListener("size", ({detail: {width: c}})=>{
                this.s.frameWidth = c
            }
            );
            this.fm.addEventListener("pos", ({detail: {x: c, y: d}})=>{
                this.s.framePos = {
                    x: c,
                    y: d
                }
            ...
            this.fm.addEventListener("orien", ({detail: {orien: c}})=>{
                this.s.frameOrien = c
            }
            );
            ...
            this.queryBlurHandler = this.queryBlurHandler.bind(this);
            document.addEventListener("_ref_progress", ({detail: {percentage: c}})=>{
                this.updateProgress(c)
            }
            );
            document.addEventListener("_ref_results", ({detail: {images: c, isLastPage: d, isFirstPage: e, searchEngine: g, query: f}})=>{
                g === this.pendingSearch && (this.searchData = e ? c : [...this.searchData, ...c],
            ...
            document.addEventListener("_ref_complete", ({detail: {base64: c, width: d, height: e, url: g, query: f, type: h, isFromHistory: k, inFrame: l, openInBg: m}})=>{
                if (l)
                    this.base64ToBlob(c).then(n=>{
                        this.openFrame(n, m)
                    }
                    );
                else {
                    if (g !== this.pendingImage)
                        return;
                    k || this.addToHistory(g, d, e, f);
                    this.pendingImage = null;
                    this.showPreview(c, d, e, {
                        query: f,
                        type: h,
                        url: g
                    })
            ...
            document.addEventListener("_ref_error", ({detail: {type: c, previewURL: d, width: e, height: g, query: f, isFromHistory: h, inFrame: k, openInBg: l}})=>{
                "image" === c && d ? this.downloadImage(d, e, g, f, null, h, k, l) : k || ("search" === c ? this.pendingSearch = null : this.pendingImage = null);
                this.hideProgress()
            }
            );
            this.gpproxy.addEventListener("turn_started", c=>{
            ...
            this.gpproxy.addEventListener("turns_ended", c=>{
                this.fm.clear()
            }
            );
        ...
        terminate() {
            this.container && (this.pendingSearch = this.pendingImage = null,
            this.isReRenderNeeded = this.isResizing = !1,
            this.container.remove(),
        ...
        render() {
            ...
            a.addEventListener("drop", async c=>{
                c.preventDefault();
                let d;
                c.dataTransfer.items && "file" === c.dataTransfer.items[0].kind ? d = c.dataTransfer.items[0].getAsFile() : c.dataTransfer.files.length && (d = c.dataTransfer.files[0]);
                if (d && GPReference_.IMAGE_TYPES.has(d.type)) {
                    const e = new FileReader;
                    e.addEventListener("loadend", g=>{
            ...
            this.queryInput.addEventListener("keydown", c=>{
                if ("Enter" === c.key) {
                    ...
                    GPReference_.URL_PATTERN.test(d) ? this.openImageURL(d) : d && (this.lastQuery = d,
                    this.searchImages(d, !1));
                    c.target.blur()
                } else
                    "Escape" === c.key && c.target.blur()
            }
            );
            this.queryInput.addEventListener("focus", c=>{
                c.target.select();
                document.dispatchEvent(new CustomEvent("_keys_lock",{
                    detail: {
                        state: !0
                ...
                document.addEventListener("pointerdown", this.queryBlurHandler, !0)
            }
            );
            this.queryInput.addEventListener("blur", c=>{
                window.getSelection().removeAllRanges();
                document.dispatchEvent(new CustomEvent("_keys_lock",{
                    detail: {
                        state: !1
            ...
            this.historyList.addEventListener("pointerup", c=>{
                if (c = c.target.closest(".history-item_")) {
                    var {url: d, width: e, height: g, query: f} = c.dataset;
                    this.downloadImage(d, e, g, f, null, !0);
                    this.historyList.classList.remove("shown_")
                }
            }
            );
            ...
            this.searchEngines.addEventListener("pointerup", c=>{
                if (c.target.classList.contains("search-engine_")) {
                    ...
                    if (d !== this.s.searchEngine) {
                        ...
                        Array.from(this.searchEngines.children).forEach(g=>{
                            g.style.order = +(g !== c.target)
                        }
                        );
            ...
            this.imageObserver = new IntersectionObserver(c=>{
                c.forEach(d=>{
                    const e = d.target;
                    d.isIntersecting && (e.src = e.dataset.src,
                    this.imageObserver.unobserve(e))
                }
                )
            }
            ,{
        ...
        queryBlurHandler(a) {
            a.target !== this.queryInput && (this.queryInput.blur(),
            document.removeEventListener("pointerdown", this.queryBlurHandler, !0))
        }
        searchByEngine(a, b) {
            a && (this.lastQuery = a,
            this.searchImages(a, !1));
        ...
        searchImages(a, b) {
            a && (this.pendingImage = null,
            this.pendingSearch = this.s.searchEngine,
            document.dispatchEvent(new CustomEvent("_ref_search",{
                detail: {
        ...
        renderImages({images: a, isFirstPage: b, query: c, scrollPos: d}) {
            if (a?.length) {
                var e = Array(this.columnsCount).fill(0)
                  , g = Array(this.columnsCount).fill().map(()=>document.createDocumentFragment());
                if (b)
                    for (this.results.innerHTML = "",
                    this.results.scrollTop = 0,
                    this.results.dataset.query = c,
                    this.columns = [],
                    b = 0; b < this.columnsCount; b++) {
                        const f = document.createElement("div");
                        f.className = "column_";
                        f.dataset.index = `${b}`;
                        this.columns[b] = f;
                    ...
                    e.map((f,h)=>+this.columns[h].dataset.height);
                a.forEach(f=>{
                    var h = f.image.width / f.image.height;
                    const k = document.createElement("div");
                    k.className = "preview_";
                    k.style.backgroundColor = f.dominantColor;
                    k.dataset.url = f.image.url;
                    k.dataset.previewURL = f.preview.url;
                    k.dataset.width = f.image.width;
                    k.dataset.height = f.image.height;
                    k.dataset.aspectRatio = h;
                    const l = new Image;
                    l.width = h * GPReference_.PREVIEW_MAX_HEIGHT;
                    l.height = GPReference_.PREVIEW_MAX_HEIGHT;
                    l.dataset.src = f.preview.url;
                    k.appendChild(l);
                    this.imageObserver.observe(l);
                    h = this.getMinHeightColumnIndex(e);
                    g[h].appendChild(k);
                    e[h] += f.image.height / f.image.width
                }
                );
                this.columns.forEach((f,h)=>{
                    f.dataset.height = e[h];
                    f.appendChild(g[h])
                }
                );
        ...
        async showPreview(a, b, c, {query: d, type: e, url: g}) {
            ...
            this.imageWidth = b;
            this.imageHeight = c;
            (a = this.history.get(g)?.pos) ? this.zoomer.setState(a) : this.zoomer.reset();
            this.isRefOpened = !0
        }
        ...
        onImageMDown(a) {
            2 === a.button && (this.isCropping ? (this.isCropping = !1,
            this.cropper.remove()) : document.addEventListener("mouseup", b=>{
        ...
        cropImage(a) {
            if (a.target === this.imageWrapper && this.image.metadata.type !== GPReference_.SVG_TYPE) {
                ...
                var b = a.pageX
                  ...
                  , g = d === e.height ? e.height / this.image.naturalHeight : e.width / this.image.naturalWidth
                  , f = Math.round(a.clientX - e.x) / g
                  , h = Math.round(a.clientY - e.y) / g;
                this.isCropping = !0;
                var k = (l=>{
                    this.isCropping || this.image.removeEventListener("pointermove", k);
                    const m = Math.min(b, l.pageX)
                      , n = Math.min(c, l.pageY)
                      , p = Math.max(b, l.pageX);
                    l = Math.max(c, l.pageY);
                    this.cropper.style.left = `${m}px`;
                    this.cropper.style.top = `${n}px`;
                    this.cropper.style.width = `${p - m}px`;
                ...
                this.image.addEventListener("pointerup", l=>{
                    ...
                    this.cropper.remove();
                    this.cropper = null;
                    this.isCropping && this.getCroppedImage(f, h, Math.round(l.clientX - e.x) / g, Math.round(l.clientY - e.y) / g).then(m=>{
        ...
        calculateOrientation() {
            ...
            a === this.image.height ? (this.image.style.setProperty("--gp-ref-img-width", "unset"),
            this.image.style.setProperty("--gp-ref-img-height", b)) : (this.image.style.setProperty("--gp-ref-img-width", b),
        ...
        getCroppedImage(a, b, c, d) {
            return new Promise(e=>{
                ...
                var k = Math.max(b, d);
                const l = Math.min(g, 0)
                  , m = Math.min(f, 0)
                  , n = g - l
                  , p = f - m;
                g = Math.abs(h - g) - (Math.max(h - this.image.naturalWidth, 0) - l);
                f = Math.abs(k - f) - (Math.max(k - this.image.naturalHeight, 0) - m);
                k = document.createElement("canvas");
                k.width = g;
                k.height = f;
                k.getContext("2d").drawImage(this.image, n, p, g, f, 0, 0, g, f);
                k.toBlob(e)
            }
            )
        }
        ...
        openImage(a) {
            if (a.target.classList.contains("preview_")) {
                var {url: b, width: c, height: d, previewURL: e} = a.target.dataset
                  , g = 0 === a.button && (a.ctrlKey || 2 === a.buttons);
                a = g && a.ctrlKey;
                this.downloadImage(b, c, d, this.results.dataset.query, e, null, g, a);
                g && !a && document.addEventListener("contextmenu", f=>{
                    f.preventDefault()
                }
                , {
                    once: !0
        ...
        closeImage(a) {
            this.results.dataset.query && (this.isRefOpened = !1,
            this.zoomer.reset(),
            this.container.classList.remove("image-opened_"),
            this.isReRenderNeeded && (this.calculateColumnsCount(),
            this.renderImages({
                images: this.searchData,
                isFirstPage: !0,
                query: this.results.dataset.query
        ...
        renderHistory() {
            ...
            const a = document.createDocumentFragment();
            Array.from(this.history).reverse().forEach(([b,{width: c, height: d, query: e}],g)=>{
                const f = document.createElement("div");
                f.className = "history-item_";
                f.dataset.url = b;
                f.dataset.width = c;
                f.dataset.height = d;
                f.dataset.query = e;
                b = document.createElement("div");
                b.className = "index_";
                b.textContent = `${this.history.size - g}.`;
                f.appendChild(b);
                g = document.createElement("div");
                g.className = "label_";
                g.textContent = e;
        ...
        onResize() {
            this.s.enabled && (this.isRefOpened ? this.isReRenderNeeded = !0 : (this.calculateColumnsCount(),
            this.renderImages({
                images: this.searchData,
                isFirstPage: !0,
                query: this.results.dataset.query
        ...
        updateSettings({detail: {settings: a}}) {
            ...
            "maxZoom"in a && this.zoomer.setMaxScale(a.maxZoom),
            "stretchImage"in a && this.isRefOpened && (this.calculateOrientation(),
            this.zoomer.reset(),
            this.updateHistoryState()),
            "frameStickyEdges"in a && this.fm.setStickyEdges(a.frameStickyEdges),
            "frameStickyEdgesDistance"in a && this.fm.setStickyEdgesDistance(a.frameStickyEdgesDistance),
            "frameSeparateOpacity"in a && this.fm.setSeparateOpacity(a.frameSeparateOpacity))
        }
    }
    ...
    class GPReferenceFrameManager_ extends EventTarget {
        ...
        toFront(a) {
            this.topFrame !== a && (a.setZIndex(this.getNextZIndex()),
            this.topFrame = a);
            ...
            this.frames.forEach(k=>{
                if (k !== a && !k.isSeparated && !k.isChanged) {
                    const l = [k.offsetY, k.offsetY + k.height]
                      , m = g.get(k.offsetX);
                    m ? m.push(l) : g.set(k.offsetX, [[b, b], l]);
                    k.offsetX > h && (h = k.offsetX)
                }
            }
            );
            for (let[k,l] of g)
                for (l.sort((m,n)=>m[0] - n[0]),
                c = 0; c < l.length; c++)
                    if ([,e] = l[c],
                    [f] = c !== l.length - 1 ? l[c + 1] : [document.documentElement.clientHeight, document.documentElement.clientHeight],
                    f - (e + d) >= a.height)
                        return [k, e + d];
    ...
    class GPReferenceFrame_ {
        ...
        changeSize(a) {
            ...
            this.fm.isSingleFrame() && (this.fm.width = a,
            this.dispatchSize(a))
        }
        toFront() {
        ...
        moveHandler(a) {
            if (0 === a.button) {
                var b = this.frame.dataset.orien
                  , c = this.offsetX
                  , d = this.offsetY
                  , [e,g,f,h] = this.getCoords(a)
                  , k = (l=>{
                    const [m,n,p] = this.getStickyCoords(l, l.pageX - e, l.pageY - g, f, h);
                    this.setPosition(m, n, f, h, p)
                }
                ).bind(this);
                ...
                this.frame.addEventListener("pointerup", ()=>{
                    ...
                    this.staticOrientation || this.frame.dataset.orien === b || (this.fm.orien = this.frame.dataset.orien,
        ...
        getStickyCoords(a, b, c, d, e) {
            if (this.fm.stickyEdges && a.ctrlKey || !this.fm.stickyEdges && !a.ctrlKey || !this.fm.hasFrames())
                return [b, c, null];
            const g = this.fm.stickyEdgesDistance;
            let f, h, k, l, m = null, n, p;
            this.fm.getFrames().forEach(r=>{
                if (r !== this) {
                    var q = r.frame.getBoundingClientRect();
                    var t = Math.abs(q.y - (c + e));
                    t < g && (void 0 === k || t < k) && q.x + q.width >= b && q.x <= b + d && (!p || p[0] === r.frame.dataset.orien[0]) && (k = t,
                    c = q.y - e,
                    m = p = r.frame.dataset.orien);
                    t = Math.abs(q.y + q.height - c);
                    t < g && (void 0 === l || t < l) && q.x + q.width >= b && q.x <= b + d && (!p || p[0] === r.frame.dataset.orien[0]) && (l = t,
                    c = q.y + q.height,
                    m = p = r.frame.dataset.orien);
                    t = Math.abs(q.x - (b + d));
                    t < g && (void 0 === f || t < f) && q.y + q.height >= c && q.y <= c + e && (!n || n[1] === r.frame.dataset.orien[1]) && (f = t,
                    b = q.x - d,
                    m = n = r.frame.dataset.orien);
                    t = Math.abs(q.x + q.width - b);
                    t < g && (void 0 === h || t < h) && q.y + q.height >= c && q.y <= c + e && (!n || n[1] === r.frame.dataset.orien[1]) && (h = t,
                    b = q.x + q.width,
                    m = n = r.frame.dataset.orien)
                }
            }
        ...
        resizeHandler(a) {
            if (2 === a.button) {
                var b = this.width
                  ...
                  , g = (f=>{
                    f = f.pageX - c;
                    this.setSize(Math.min(Math.max(d + (e[1] === GPReferenceFrame_.ORIENTATION.LEFT ? f : -f), this.minWidth), GPReferenceFrame_.MAX_WIDTH))
                }
                ).bind(this);
                this.frame.setPointerCapture(a.pointerId);
                this.frame.addEventListener("pointermove", g);
                this.frame.addEventListener("pointerup", f=>{
                    document.addEventListener("contextmenu", this.suppressEvent, {
                        once: !0
                    });
                    this.frame.removeEventListener("pointermove", g);
                    this.frame.classList.remove("resizing_");
                    this.isChanged || this.handleChange();
                    this.fm.isSingleFrame() && this.width !== b && (this.fm.width = this.width,
                    this.dispatchSize(this.width))
                }
                , {
                    once: !0
                });
        ...
        setPosition(a, b, c, d, e) {
            ...
            if (this.fm.staticOrientation)
                ...
                h = c,
                k = d;
            h = Math.max(Math.min(a, g - (h + GPReferenceFrame_.BORDER_WIDTH)), GPReferenceFrame_.BORDER_WIDTH);
            k = Math.max(Math.min(b, f - (k + GPReferenceFrame_.BORDER_WIDTH)), GPReferenceFrame_.BORDER_WIDTH);
            a = e ?? (this.fm.staticOrientation ? GPReferenceFrame_.DEFAULT_ORIENTATION : (b + d / 2 > f / 2 ? GPReferenceFrame_.ORIENTATION.BOTTOM : GPReferenceFrame_.ORIENTATION.TOP) + (a + c / 2 > g / 2 ? GPReferenceFrame_.ORIENTATION.RIGHT : GPReferenceFrame_.ORIENTATION.LEFT));
            this.frame.dataset.orien = a;
            this.frame.style.inset = "unset";
            a[0] === GPReferenceFrame_.ORIENTATION.TOP ? (this.offsetY = Math.round(k),
            this.frame.style.top = `${this.offsetY}px`) : (this.offsetY = Math.round(f - (k + d)),
            this.frame.style.bottom = `${this.offsetY}px`);
            a[1] === GPReferenceFrame_.ORIENTATION.LEFT ? (this.offsetX = Math.round(h),
            this.frame.style.left = `${this.offsetX}px`) : (this.offsetX = Math.round(g - (h + c)),
        ...
        load(a) {
            ...
            this.image.onload = c=>{
                ...
                if (this.isSeparated)
                    ...
                    const [g,f] = this.fm.getAlignedCoords(this);
                    this.offsetX = g;
                    this.offsetY = f;
    ...
    ;class GPPlayersManager_ extends EventTarget {
        ...
        static INIT(a) {
            new GPPlayersManager_(a.gpproxy,a.sm)
        }
        constructor(a, b) {
            super();
            this.gpproxy = a;
            this.s = b.setSettings(this);
            this.currentPath = null;
            this.onAlbumMiddleClick = this.onAlbumMiddleClick.bind(this);
            this.onAlbumDoubleClick = this.onAlbumDoubleClick.bind(this);
            this.onImageMiddleClick = this.onImageMiddleClick.bind(this);
            this.onImageDoubleClick = this.onImageDoubleClick.bind(this);
            document.addEventListener("_url_changed", ({detail: {path: c}})=>{
                this.currentPath = c.slice(1)
            }
            );
            this.gpproxy.addEventListener("data", ({detail: {event: c}})=>{
                c === GPProxy_.EVENT.TURN_STARTED ? this.closePlayers() : c === GPProxy_.EVENT.GAME_STARTED ? (document.addEventListener("pointerdown", this.onImageMiddleClick),
                document.addEventListener("dblclick", this.onImageDoubleClick)) : [GPProxy_.EVENT.ALBUM_INFO, GPProxy_.EVENT.NEW_GAME, GPProxy_.EVENT.ALBUM_SCORE, GPProxy_.EVENT.GAME_QUIT].includes(c) ? (this.closePlayers(),
                c !== GPProxy_.EVENT.ALBUM_INFO && (document.removeEventListener("pointerdown", this.onAlbumMiddleClick),
                document.removeEventListener("dblclick", this.onAlbumDoubleClick))) : c === GPProxy_.EVENT.GALLERY_SETTINGS && (document.addEventListener("pointerdown", this.onAlbumMiddleClick),
                document.addEventListener("dblclick", this.onAlbumDoubleClick),
                document.removeEventListener("pointerdown", this.onImageMiddleClick),
                document.removeEventListener("dblclick", this.onImageDoubleClick))
            }
            );
            this.gpproxy.addEventListener("rejoin", ({detail: {stage: c}})=>{
                switch (c) {
                case GPProxy_.STAGE.GAME:
                    document.addEventListener("pointerdown", this.onImageMiddleClick);
                    document.addEventListener("dblclick", this.onImageDoubleClick);
                    break;
        ...
        onImageMiddleClick(a) {
            1 === a.button && this.handleImageClick(a)
        }
        onImageDoubleClick(a) {
        ...
        renderPlayer(a, b, c, d, e, g) {
            const f = new GPTimelapsePlayer_({
                image: a,
                container: b,
                mainContainer: c
            },d || this.s.defaultDisplayMode,g);
            (e ?? this.s.autoplay) && f.addEventListener("data-loaded", ()=>{
                f.play()
            }
            )
        }
    ...
    class GPTimelapsePlayer_ extends EventTarget {
        ...
        constructor({image: {data: a, background: b, auth: c, meta: {author: d, title: e, date: g}}, container: f, mainContainer: h}, k=GPTimelapsePlayer_.DEFAULT_DISPLAY_MODE, l=!1) {
            super();
            ...
            const [m,n,p] = this.handleDelimiters(a, b);
            this.data = m;
            this.background = n;
            this.auth = c;
            this.author = d;
            ...
            this.isContextLayoutShown = this.isFullscreen = this.isExpanded = !1;
        ...
        initData() {
            ...
            for (let b = 0; b < this.data.length; b++)
                this.data[b].index = b,
                this.isMStroke(this.data[b]) && a.push(b);
            a.reverse().forEach(b=>{
        ...
        render() {
            ...
            b.addEventListener("pointermove", e=>{
                const [g,,f] = this.getCoords(e);
                d.style.width = `${100 * Math.max(0, Math.min(1, g / f))}%`
            }
            , !0);
            b.addEventListener("pointerdown", e=>{
                if (0 === e.button) {
                    var g = this.isPlaying;
                    ...
                    b.addEventListener("pointerup", f=>{
                        ...
                        g && this.pos < this.data.length && this.play()
                    }
                    , {
                        once: !0
                    })
            ...
            this.speedView.addEventListener("pointerdown", e=>{
                const {x: g, y: f} = this.player.getBoundingClientRect()
                  , h = (e.clientY - f - (e.clientY - e.target.getBoundingClientRect().y)) / this.scaleY;
                this.renderSpeedInput((e.clientX - g) / this.scaleX, h);
        ...
        toggleContextLayout() {
            this.isContextMenuDisabled || (this.pause(),
            this.isContextLayoutShown = !this.isContextLayoutShown,
            this.player.classList.toggle("context-menu_", this.isContextLayoutShown))
        }
        updateSpeedView() {
        ...
        resizeHandler() {
            ...
            if (document.fullscreenElement === this.player)
                ...
                let {width: e, height: g} = getComputedStyle(d);
                e = parseInt(e);
                g = parseInt(g);
                const {width: f, height: h} = this.lastContainerDimension;
                if (d !== this.mainContainer || e !== f || g !== h)
                    this.setSize(e, g),
                    this.lastContainerDimension = {
                        width: e,
                        height: g
        ...
        setSize(a, b) {
            const {density: c, canvasWidth: d, canvasHeight: e} = this.getDensityByDimensions(a, b)
              , {width: g, height: f} = this.calculateAspectRatioFit(GPTimelapsePlayer_.ORIGINAL_WIDTH, GPTimelapsePlayer_.ORIGINAL_HEIGHT, a, b);
            a = document.documentElement.style;
            a.setProperty("--timelapse-player-width", `${Math.round(g)}px`);
            a.setProperty("--timelapse-player-height", `${Math.round(f)}px`);
            this.density = c;
            this.width = d;
            this.height = e;
        ...
        redraw() {
            ...
            if (this.background) {
                this.clearBackground();
                var a = this.getCache();
                this.cache[this.density] ? (a = a.at(-1),
                this.bgCtx.putImageData(a, 0, 0)) : this.drawFunction(this.bgCtx, this.background, this.density, !1)
            } else
                this.bgCtx.fillStyle = GPTimelapsePlayer_.BACKGROUND_COLOR,
                this.bgCtx.fillRect(0, 0, this.bgCanvas.width, this.bgCanvas.height);
            this.clearCanvas();
            ...
            this.clearStroke();
            this.stroke && (a = this.stroke.slice(0, GPTimelapsePlayer_.STROKE_OFFSET + this.sPos + 1),
        ...
        expand(a) {
            ...
            this.isExpanded ? this.mainContainer.appendChild(this.player) : this.container.appendChild(this.player);
            this.resizeHandler()
        }
        playPause() {
        ...
        drawing() {
            if (this.stroke)
                this.drawingStroke(this.stroke);
            else if (this.pos < this.data.length) {
                const a = this.data.slice(this.pos, this.pos + this.speed[1])
                  , b = a.at(-1);
                this.speed[0] && [1, 2].includes(b[0]) ? (this.sPos = 0,
                this.stroke = b,
                this.drawingStroke(b)) : (this.draw(this.ctx, a),
                this.pos = Math.min(this.data.length, this.pos + this.speed[1]),
                this.pos < this.data.length ? this.timer = requestAnimationFrame(this.drawing) : (this.player.classList.add("finished_"),
                this.pause()),
                this.updateProgress(),
                this.updateStrokeView())
            } else
        ...
        getCoords(a, b) {
            ...
            const [c,d] = a.touches ? [a.touches[0].clientX, a.touches[0].clientY] : [a.clientX, a.clientY]
              , [e,g] = [c - b.left, d - b.top];
            return [Math.round(e), Math.round(g), b.width, b.height]
        }
        ...
        toggleFullscreen() {
            document.fullscreenElement ? document.exitFullscreen() : (this.expand(!1),
            this.player.requestFullscreen())
        }
        saveImage() {
            ...
            if (this.background) {
                var d = this.getCache();
                this.cache[this.density] ? (d = d.at(-1),
                c.putImageData(d, 0, 0)) : this.drawFunction(c, this.background, this.density, !1)
            }
        ...
        draw(a, b, c, d, e=!0) {
            if (b) {
                var g = GPTimelapsePlayer_.CACHE_INTERVAL;
                if (GPTimelapsePlayer_.CACHE_ENABLE && e && b.length > g)
                    if (e = this.getCache(),
                    !this.cache[this.density] && b.at(-1).index + 1 < g)
                        this.drawFunction(a, b, c, d);
                    else {
                        const f = Math.floor((b.at(-1).index + 1) / g) - 1;
                        a.putImageData(e[f], 0, 0);
                        b = b.slice(-(b.at(-1).index + 1 - (f + 1) * g));
                        this.drawFunction(a, b, c, d)
                    }
                else
                    this.drawFunction(a, b, c, d)
        ...
        drawFunction(a, b, c=this.density, d=this.eraserAlpha, e=!1, f=!1) {
            f && (a.beginPath(),
            a.rect(0, 0, 1, 1),
            a.fill());
            a.lineCap = a.lineJoin = "round";
        ...
        initCacheWorker() {
            ...
            d = parseInt(d);
            e = parseInt(e);
            const {density: g} = this.getDensityByDimensions(d, e)
              , {density: f} = this.getDensityByDimensions(window.screen.width, window.screen.height)
              , h = [...(new Set([c, g, f]))];
            ...
            this.worker.addEventListener("message", ({data: k})=>{
                ...
                ) : "cache-updated" === k.type && (this.cache = k.cache,
                this.dispatchEvent(new CustomEvent("cache-updated",{
                    detail: {
                        density: k.density
                    }
                })))
            ...
            this.worker.postMessage({
                ...
                draw: this.getFuncBody(this.drawFunction),
                fi: this.fi,
        ...
        cacheWorkerBody() {
            function a(g) {
                ...
                if (!this.cache[g]) {
                    ...
                    f = new OffscreenCanvas(f,h);
                    h = f.getContext("2d", {
                        willReadFrequently: !0
                    });
                    let n;
                    self.background && (h.fillStyle = d,
                    h.fillRect(0, 0, f.width, f.height),
                    self.draw(h, this.background, g, !1),
                    n = h.getImageData(0, 0, f.width, f.height),
                    h.clearRect(0, 0, f.width, f.height));
                    for (let p = 0; p < m; p++) {
                        var k = p * l;
                        k = self.data.slice(k, k + l);
                        self.draw(h, k, g, self.eraserAlpha);
                        k = h.getImageData(0, 0, f.width, f.height);
                        this.cache[g].push(k)
                    }
                    self.background && this.cache[g].push(n)
                }
            }
            let b, c, d, e;
            self.data;
            ...
            self.addEventListener("message", ({data: g})=>{
                ...
                self.postMessage({
                    type: "worker-ready"
                })) : "get-cache" === g.type && (self.cache[g.density] || a(g.density),
                self.postMessage({
                    type: "cache-updated",
                    cache: self.cache,
                    density: g.density
